from orbex.addons.account_edi_ubl_cii.tests.common import TestUblBis3Common, TestUblCiiFRCommon
from orbex.addons.l10n_fr_facturx_chorus_pro.tests.common import TestUblCiiCommonChorusPro
