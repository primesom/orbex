...
from orbex import fields, tests
from orbex.addons.mail.models.mail_activity import MailActivity
from orbex.addons.mail.tests.common import mail_new_test_user
from orbex.addons.test_mail.tests.test_mail_activity import TestActivityCommon
