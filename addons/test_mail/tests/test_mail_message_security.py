...
from orbex.addons.test_mail.models.mail_test_access import MailTestAccess
...
class TestMailMessageAccess(MessageAccessCommon):
    ...
    @mute_logger('orbex.addons.base.models.ir_model', 'orbex.addons.base.models.ir_rule')
