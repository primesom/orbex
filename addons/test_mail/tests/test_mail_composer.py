...
from orbex.addons.mail.wizard.mail_compose_message import MailComposeMessage
...
from orbex.fields import Datetime as FieldDatetime
from orbex.exceptions import AccessError, UserError
from orbex.tests import Form, tagged, users
from orbex.tools import email_normalize, mute_logger, formataddr
...
class TestComposerInternals(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('orbex.tests', 'orbex.addons.mail.models.mail_mail', 'orbex.models.unlink')
    ...
    @mute_logger('orbex.tests', 'orbex.addons.base.models.ir_rule', 'orbex.addons.mail.models.mail_mail', 'orbex.models.unlink')
...
class TestComposerResultsComment(TestMailComposer, CronMixinCase):
    ...
    @users('employee')
    @mute_logger('orbex.models.unlink', 'orbex.addons.mail.models.mail_mail', 'orbex.addons.mail.models.mail_message_schedule')
...
class TestComposerResultsMass(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('orbex.models.unlink', 'orbex.addons.mail.models.mail_mail')
