...
from orbex import fields, exceptions, tests
from orbex.addons.mail.tests.common import mail_new_test_user
from orbex.addons.mail.tests.common_activity import ActivityScheduleCase
from orbex.addons.test_mail.models.test_mail_models import MailTestActivity
from orbex.tests import Form, HttpCase, users
from orbex.tests.common import freeze_time
...
class TestActivitySystray(TestActivityCommon, HttpCase):
    ...
    def test_systray_activities_for_various_records(self):
        ...
        self.assertEqual(len(test_with_removed), 4, 'Even with ACL check, activities linked to removed records are kept if assigned to the user (see orbex/orbex#112126)')
