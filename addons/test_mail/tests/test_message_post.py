...
from orbex.addons.base.tests.test_ir_cron import CronMixinCase
from orbex.addons.mail.tests.common import mail_new_test_user, MailCommon
from orbex.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE_PLAINTEXT
from orbex.addons.test_mail.models.test_mail_models import MailTestSimple
from orbex.addons.test_mail.tests.common import TestRecipients
from orbex.service.model import call_kw
from orbex.exceptions import AccessError
from orbex.tests import tagged
from orbex.tools import mute_logger, formataddr
from orbex.tests.common import users
...
class TestMailNotifyAPI(TestMessagePostCommon):
    ...
    @mute_logger('orbex.models.unlink')
    @users('employee')
...
class TestMessageNotify(TestMessagePostCommon):
    ...
    @users('employee')
    @mute_logger('orbex.addons.mail.models.mail_mail', 'orbex.models.unlink', 'orbex.tests')
...
class TestMessagePost(TestMessagePostCommon, CronMixinCase):
    ...
    @mute_logger('orbex.addons.mail.models.mail_mail', 'orbex.models.unlink')
    @users('employee')
    def test_message_post(self):
        ...
        exp_headers = {
            ...
            'X-Orbex-Objects': f'{test_record._name}-{test_record.id}',
        }
        with self.assertSinglePostNotifications(
                [
                    {'partner': self.partner_employee_2, 'type': 'inbox'},
    ...
    def test_message_post_inactive_follower(self):
        """ Test posting with inactive followers does not notify them (e.g. orbexbot) """
        test_record = self.env['mail.test.simple'].browse(self.test_record.ids)
                ...
                with self.assertSinglePostNotifications(
                        ...
                        message_info={
                            ...
                            'mail_mail_values': {
                                'headers': {
                                    'Return-Path': f'{expected_alias_domain.bounce_alias}@{expected_alias_domain.name}',
                                    'X-Orbex-Objects': f'{record._name}-{record.id}',
                                },
                            },
                            'message_values': {
    ...
    @mute_logger('orbex.addons.mail.models.mail_mail', 'orbex.tests')
    ...
    @users('employee')
    @mute_logger('orbex.addons.mail.models.mail_mail', 'orbex.addons.mail.models.mail_message_schedule', 'orbex.models.unlink')
    ...
    @mute_logger('orbex.addons.mail.models.mail_mail', 'orbex.addons.mail.models.mail_message_schedule')
    ...
    @mute_logger('orbex.addons.base.models.ir_model', 'orbex.addons.mail.models.mail_mail')
