...
from orbex.addons.payment_paymob.controllers.main import PaymobController
from orbex.addons.payment_paymob.tests.common import PaymobCommon
...
class PaymobTest(PaymobCommon, PaymentHttpCommon):
    ...
    @mute_logger('orbex.addons.payment_paymob.controllers.main')
