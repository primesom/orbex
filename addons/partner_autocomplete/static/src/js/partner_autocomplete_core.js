...
import { onWillStart } from "@orbex/owl";
...
export function usePartnerAutocomplete() {
    const keepLastOrbex = new KeepLast();
    ...
    /**
     * Use Orbex Autocomplete API to return suggestions
     *
     * @param {string} value
     * @param {boolean} isVAT
     * @returns {Promise}
    ...
    async function getSuggestions(value, isVAT, queryCountryId) {
        ...
        const suggestions = await keepLastOrbex.add(prom);
