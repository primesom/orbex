...
class Browser:
    ...
    def close_browser(self):
        """close the browser"""
        # Kill browser instance (can't `instance.pkill()` as we can't keep the instance after Orbex service restarts)
        # We need to terminate it because Orbex will create a new instance each time it is restarted.
