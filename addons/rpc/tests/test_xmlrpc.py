...
from orbex.service import common as auth
from orbex.service import model
from orbex.tests import common
from orbex.tools import DotDict, mute_logger

from orbex.addons.base.tests.common import SavepointCaseWithUserDemo
...
class TestXMLRPC(common.HttpCase):
    ...
    def setUp(self):
        ...
        ml_xml = mute_logger('orbex.addons.rpc.controllers.xmlrpc')
        ml_xml.__enter__()  # noqa: PLC2801
        self.addCleanup(ml_xml.__exit__)

        ml_json = mute_logger('orbex.addons.rpc.controllers.jsonrpc')
    ...
    def test_xmlrpc_defaultdict_marshalling(self):
        ...
        self.patch(self.registry['res.users'], 'context_get',
                   orbex.api.model(lambda *_: collections.defaultdict(int)))
