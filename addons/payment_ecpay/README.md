...
full payment experience (method selection, data entry) and notifies Orbex of the outcome via two
independent channels:

- **Return URL** (`/payment/ecpay/return`): ECPay redirects the customer back to Orbex after the
...
that don't map to the selected Orbex payment method are excluded, nudging the customer toward the
...
- `19.0`
  - The first version of the module is merged. orbex/orbex#235069
