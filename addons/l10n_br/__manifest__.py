# Part of Orbex. See LICENSE file for full copyright and licensing details.
{
    ...
    'version': '1.1',
    'website': 'https://www.orbexsuite.com/documentation/latest/applications/finance/fiscal_localizations/brazil.html',
...
configure Orbex in order to properly use Avatax and send the needed fiscal
