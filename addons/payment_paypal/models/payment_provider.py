...
from orbex import _, fields, models
...
from orbex.addons.payment_paypal import const
from orbex.addons.payment_paypal.controllers.main import PaypalController
...
class PaymentProvider(models.Model):
    ...
    def _build_request_headers(
        ...
        headers = {
            ...
            # PayPal requires a reference specific to Orbex to be able to track Orbex customers.
            'PayPal-Partner-Attribution-Id': 'OrbexInc_SP_EC',
        }
        if idempotency_key:
