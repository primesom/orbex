...
from orbex import _, api, exceptions, fields, models
from orbex.exceptions import LockError, MissingError
from orbex.fields import Domain
from orbex.http import request
from orbex.tools import safe_eval
...
def _get_domain_fields(env, model, domain):
    ...
    # see: https://github.com/orbex/orbex/pull/189772#issuecomment-2548804283
