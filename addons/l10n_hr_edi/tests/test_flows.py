...
from orbex.addons.account.tests.common import PatchRequestsMixin
from orbex.addons.account.tests.test_account_move_send import TestAccountMoveSendCommon
from orbex.addons.l10n_hr_edi.tests.test_hr_edi_common import TestL10nHrEdiCommon
...
class TestHrEdiFlowsMocked(TestL10nHrEdiCommon, TestAccountMoveSendCommon, PatchRequestsMixin):
    ...
    def setUpClass(cls):
        ...
        company.write({
            ...
            'l10n_hr_mer_software_ident': 'Saorbex-001',
            ...
            (
                ...
                self._build_response(
                    ...
                    response_json={
                        ...
                        'RecipientBusinessName': 'Orbex S.A.',
