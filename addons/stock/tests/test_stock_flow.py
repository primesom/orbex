...
from orbex.addons.stock.tests.common import TestStockCommon
from orbex.exceptions import ValidationError
from orbex.tests import Form, HttpCase, tagged
from orbex.tests.common import users
from orbex.tools import mute_logger, float_round
...
class TestStockFlowTourPostInstall(TestStockCommon, HttpCase):
    ...
    def test_basic_stock_flow_with_minimal_access_rights(self):
        ...
        self.start_tour('/orbex', 'test_basic_stock_flow_with_minimal_access_rights', login='pauline')
