...
from orbex.tools import Query, SQL
from orbex.tools.barcode import check_barcode_encoding
from orbex.tools.float_utils import float_compare
from orbex.tools.mail import html2plaintext, is_html_empty
...
class ProductTemplate(models.Model):
    ...
    def _default_responsible_id(self):
        # Return the current user unless it's OrbexBot
