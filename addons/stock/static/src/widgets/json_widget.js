...
import { Component, onWillStart, useEffect, useRef } from "@orbex/owl";
...
export class ReplenishmentGraphWidget extends JsonPopOver {
    ...
    getScatterGraphConfig() {
        ...
        const maxLineColor = getColor(1, cookie.get("color_scheme"), "orbex");
        const minLineColor = getColor(2, cookie.get("color_scheme"), "orbex");
        const curveLineColor = getColor(3, cookie.get("color_scheme"), "orbex");
        return {
            type: "scatter",
            data: {
                labels,
