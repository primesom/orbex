...
from orbex.addons.account.tests.test_taxes_downpayment import TestTaxesDownPayment
from orbex.addons.point_of_sale.tests.test_frontend import TestTaxCommonPOS
from orbex.addons.sale.tests.common import TestTaxCommonSale
