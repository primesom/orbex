...
from orbex.tests import freeze_time, tagged, users
from orbex.tools import mute_logger

from orbex.addons.test_mail.tests.test_mail_composer import TestMailComposer
from orbex.addons.test_mass_mailing.tests import common
...
class TestMailComposerMassMailing(TestMailComposer, common.TestMassMailCommon):
    ...
    @mute_logger('orbex.addons.mass_mailing.models.mailing')
