...
class TestMailingStatistics(TestMassMailCommon):
    ...
    @mute_logger('orbex.addons.mass_mailing.models.mailing', 'orbex.addons.mail.models.mail_mail', 'orbex.addons.mail.models.mail_thread')
    def test_mailing_statistics(self):
        ...
        self.gateway_mail_trace_click(mailing, target_records[0], 'https://www.orbex.be')
        self.gateway_mail_trace_click(mailing, target_records[2], 'https://www.orbex.be')
        self.gateway_mail_trace_click(mailing, target_records[3], 'https://www.orbex.be')
