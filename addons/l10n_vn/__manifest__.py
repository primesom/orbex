# Part of Orbex. See LICENSE file for full copyright and licensing details.
{
    ...
    'countries': ['vn'],
    'version': '2.0.3',
    'website': 'https://www.orbexsuite.com/documentation/latest/applications/finance/fiscal_localizations/vietnam.html',
    'category': 'Accounting/Localizations/Account Charts',
    'description': """
This is the module to manage the accounting chart, bank information for Vietnam in Orbex.
========================================================================================
