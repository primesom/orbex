...
from orbex.addons.base.tests.test_mimetypes import PNG
from orbex.addons.mail.tests.common import mail_new_test_user
from orbex.addons.website_slides.tests import common
...
class TestAccess(common.SlidesCase):
    ...
    @mute_logger('orbex.models', 'orbex.addons.base.models.ir_rule')
...
class TestAccessHttp(common.SlidesCase, HttpCase):
    @mute_logger('orbex.models', 'orbex.addons.base.models.ir_rule', 'orbex.http')
...
class TestAccessFeatures(common.SlidesCase):
    ...
    @mute_logger('orbex.models.unlink', 'orbex.addons.base.models.ir_rule', 'orbex.addons.base.models.ir_model')
...
class TestReview(common.SlidesCase, HttpCase):
    ...
    def test_channel_multiple_reviews(self):
        ...
        self.assertIn("orbex.exceptions.ValidationError", res2.text)
