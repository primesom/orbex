...
from orbex.tests import Form, common
from orbex.tools import float_compare, mute_logger

from orbex.addons.sale.tests.common import TestSaleCommon
from orbex.addons.stock_account.tests.test_anglo_saxon_valuation_reconciliation_common import (
...
class TestSaleMrpFlow(TestSaleMrpFlowCommon):
    ...
    @mute_logger('orbex.tests.common.onchange')
