...
from orbex.addons.event_booth_sale.tests.common import TestEventBoothSaleCommon
from orbex.addons.website_event_sale.tests.common import TestWebsiteEventSaleCommon
