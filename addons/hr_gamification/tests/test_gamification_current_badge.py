...
class TestGamificationBadge(TestHrCommon):
    ...
    def setUpClass(cls):
        ...
        .create([
            {
                "name": "demo_user",
                "login": "demo@orbexsuite.com",
                "email": "demo@orbexsuite.com",
                "group_ids": [Command.link(cls.env.ref("base.group_user").id)],
            }, {
                "name": "demo2_user",
                "login": "demo2@orbexsuite.com",
                "email": "demo2@orbexsuite.com",
                "group_ids": [Command.link(cls.env.ref("base.group_user").id)],
            }, {
                "name": "demo3_user",
                "login": "demo3@orbexsuite.com",
                "email": "demo3@orbexsuite.com",
                "group_ids": [Command.link(cls.env.ref("base.group_user").id)],
            }, {
                "name": "demo4_manager",
                "login": "demo4@orbexsuite.com",
                "email": "demo4@orbexsuite.com",
