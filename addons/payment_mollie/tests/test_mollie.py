...
from orbex.addons.payment_mollie.controllers.main import MollieController
from orbex.addons.payment_mollie.tests.common import MollieCommon
...
class MollieTest(MollieCommon, PaymentHttpCommon):
    ...
    @mute_logger(
        'orbex.addons.payment_mollie.controllers.main',
        'orbex.addons.payment_mollie.models.payment_transaction',
    )
