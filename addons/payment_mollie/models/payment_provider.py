...
from orbex import _, fields, models, service
...
class PaymentProvider(models.Model):
    ...
    def _build_request_headers(self, *args, **kwargs):
        ...
        orbex_version = service.common.exp_version()['server_version']
        ...
        return {
            ...
            'User-Agent': f'Orbex/{orbex_version} MollieNativeOrbex/{module_version}',
        }
