...
class BadOrbexLinkError extends EvaluationError {
    constructor(menuId) {
        super(
...
export const spreadsheetLinkMenuCellService = {
    ...
    start(env) {
        function _getIrMenuByXmlId(xmlId) {
            ...
            if (!menu) {
                throw new BadOrbexLinkError(xmlId);
            }
            return menu;
        }

        urlRegistry
            .replace("OrbexMenuIdLink", {
                sequence: 65,
                ...
                createLink(url, label) {
                    ...
                    if (!menu) {
                        throw new BadOrbexLinkError(menuId);
                    }
                    return {
                        url,
                        label,
