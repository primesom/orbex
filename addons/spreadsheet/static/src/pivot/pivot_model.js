...
import { helpers, constants, EvaluationError, SpreadsheetPivotTable } from "@orbex/o-spreadsheet";
...
/**
 * @typedef {import("@orbex/o-spreadsheet").PivotTableColumn} PivotTableColumn
 * @typedef {import("@orbex/o-spreadsheet").PivotTableRow} PivotTableRow
 ...
 */
export class OrbexPivotModel extends PivotModel {
    /**
     * @param {import("@web/env").OrbexEnv} env
     * @param {import("@spreadsheet").OrbexPivotModelParams} params
    ...
    constructor(env, params, services) {
        ...
        /**
         * @type {import("@spreadsheet").OrbexGetters}
         */
    ...
    /**
     * Get the Orbex domain corresponding to the given domain
     * @param {PivotDomain} domain
     */
    ...
    /**
     * @param {import("@orbex/o-spreadsheet").PivotDimension} dimension
