...
/**
 *
 * @typedef {import("@spreadsheet").OrbexPivotDefinition} OrbexPivotDefinition
...
export class PivotCoreGlobalFilterPlugin extends OrbexCorePlugin {
    ...
    export(data) {
        for (const id in this.pivots) {
            ...
            data.pivots[id].fieldMatching =
                pivot.type === "ORBEX" ? this.pivots[id].fieldMatching : {};
        }
    }
}
