...
import { PivotOrbexCorePlugin } from "./plugins/pivot_orbex_core_plugin";
...
coreTypes.add("UPDATE_ORBEX_PIVOT_DOMAIN");

invalidateEvaluationCommands.add("UPDATE_ORBEX_PIVOT_DOMAIN");
...
inverseCommandRegistry.add("UPDATE_ORBEX_PIVOT_DOMAIN", identity);

export { PivotOrbexCorePlugin, PivotCoreViewGlobalFilterPlugin, PivotUIGlobalFilterPlugin };
