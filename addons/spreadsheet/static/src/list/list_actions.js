...
import { astToFormula, helpers } from "@orbex/o-spreadsheet";
...
/**
 * @param {import("@orbex/o-spreadsheet").CellPosition} position
...
/**
 * @param {import("@orbex/o-spreadsheet").CellPosition} position
 * @param {import("@spreadsheet").OrbexGetters} getters
 * @returns {boolean}
 */
export const SEE_RECORD_LIST_VISIBLE = (position, getters) => {
    ...
    return !!(
        ...
        getFirstListFunction(cell.compiledFormula.tokens).functionName === "ORBEX.LIST"
    );
};
