...
import { helpers, registries, EvaluationError } from "@orbex/o-spreadsheet";
...
functionRegistry.add("ORBEX.LIST", ORBEX_LIST);
functionRegistry.add("ORBEX.LIST.HEADER", ORBEX_LIST_HEADER);
