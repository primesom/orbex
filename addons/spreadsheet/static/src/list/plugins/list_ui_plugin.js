...
export class ListUIPlugin extends OrbexUIPlugin {
    ...
    handle(cmd) {
        switch (cmd.type) {
            case "INSERT_ORBEX_LIST_WITH_TABLE": {
                this.dispatch("INSERT_ORBEX_LIST", cmd);
                this._addTable(cmd);
                break;
            }
            case "RE_INSERT_ORBEX_LIST_WITH_TABLE": {
                this.dispatch("RE_INSERT_ORBEX_LIST", cmd);
                this._addTable(cmd);
                break;
            }
        }
