...
import { onOrbexChartItemHover, onWaterfallOrbexChartItemClick } from "./orbex_chart_helpers";
...
export class OrbexWaterfallChart extends OrbexChart {
...
chartRegistry.add("orbex_waterfall", {
    match: (type) => type === "orbex_waterfall",
    createChart: (definition, sheetId, getters) =>
        new OrbexWaterfallChart(definition, sheetId, getters),
    getChartRuntime: createOrbexChartRuntime,
    validateChartDefinition: (validator, definition) =>
        OrbexWaterfallChart.validateChartDefinition(validator, definition),
    transformDefinition: (definition) => OrbexWaterfallChart.transformDefinition(definition),
    getChartDefinitionFromContextCreation: () =>
        OrbexWaterfallChart.getDefinitionFromContextCreation(),
    name: _t("Waterfall"),
});
...
function createOrbexChartRuntime(chart, getters) {
    ...
    const config = {
        ...
        options: {
            ...
            onClick: onWaterfallOrbexChartItemClick(getters, chart),
        },
    };
