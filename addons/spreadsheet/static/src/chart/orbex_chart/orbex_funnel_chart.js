...
export class OrbexFunnelChart extends OrbexChart {
...
chartRegistry.add("orbex_funnel", {
    match: (type) => type === "orbex_funnel",
    createChart: (definition, sheetId, getters) =>
        new OrbexFunnelChart(definition, sheetId, getters),
    getChartRuntime: createOrbexChartRuntime,
    validateChartDefinition: (validator, definition) =>
        OrbexFunnelChart.validateChartDefinition(validator, definition),
    transformDefinition: (definition) => OrbexFunnelChart.transformDefinition(definition),
    getChartDefinitionFromContextCreation: () => OrbexFunnelChart.getDefinitionFromContextCreation(),
    name: _t("Funnel"),
});
