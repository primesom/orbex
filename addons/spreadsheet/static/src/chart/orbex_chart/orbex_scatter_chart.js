...
export class OrbexScatterChart extends OrbexChart {
...
chartRegistry.add("orbex_scatter", {
    match: (type) => type === "orbex_scatter",
    createChart: (definition, sheetId, getters) =>
        new OrbexScatterChart(definition, sheetId, getters),
    getChartRuntime: createOrbexChartRuntime,
    validateChartDefinition: (validator, definition) =>
        OrbexScatterChart.validateChartDefinition(validator, definition),
    transformDefinition: (definition) => OrbexScatterChart.transformDefinition(definition),
    getChartDefinitionFromContextCreation: () =>
        OrbexScatterChart.getDefinitionFromContextCreation(),
    name: _t("Scatter"),
});
