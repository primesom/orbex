...
/**
 * @typedef {Object} OrbexModelMetaData
 * @property {string} resModel
 * @property {OrbexFields} [fields]
 *
 * @typedef {Object} OrbexModelSearchParams
 * @property {Object} context
 * @property {Array<string>} domain
 */

export class OrbexViewsDataSource extends LoadableDataSource {
    /**
     * @override
     * @param {Object} services
     * @param {Object} params
     * @param {OrbexModelMetaData} params.metaData
     * @param {Object} params.searchParams
     */
    constructor(services, params) {
        super(services);
        /** @type {OrbexModelMetaData} */
    ...
    /**
     * @returns {OrbexFields} List of fields
     */
    getFields() {
     ...
     * @returns {OrbexField | undefined} Field
     */
    getField(field) {
        this._assertMetaDataLoaded();
