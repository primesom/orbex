...
import { CellErrorType, EvaluationError } from "@orbex/o-spreadsheet";
import { _t } from "@web/core/l10n/translation";

/**
 * @typedef {import("./orbex_data_provider").OrbexDataProvider} OrbexDataProvider
...
export class LoadableDataSource {
    /**
     * @param {Object} param0
     * @param {OrbexDataProvider} param0.orbexDataProvider
     */
    constructor({ orbexDataProvider }) {
        /** @protected */
    ...
    get _orm() {
        return this.orbexDataProvider.orm;
    }

    get serverData() {
        return this.orbexDataProvider.serverData;
    }
    ...
    async load(params) {
        if (params && params.reload) {
            this.orbexDataProvider.cancelPromise(this._loadPromise);
            this._loadPromise = undefined;
        }
        if (!this._loadPromise) {
            ...
            await this.orbexDataProvider.notifyWhenPromiseResolves(this._loadPromise);
        }
 ...
 * @param {string} model
 * @returns {Promise<import("@spreadsheet").OrbexFields>}
 */
