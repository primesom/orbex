...
/**
 * @typedef {import("@orbex/o-spreadsheet").Model} Model
 ...
 * @param {Model} model
 * @param {string} type
 * @param {import("@spreadsheet/chart/orbex_chart/orbex_chart").OrbexChartDefinition} definition
 */
export function insertChartInSpreadsheet(model, type = "orbex_bar", definition = {}) {
 ...
 *
 * @returns { Promise<{ model: OrbexSpreadsheetModel, env: Object }>}
 */
