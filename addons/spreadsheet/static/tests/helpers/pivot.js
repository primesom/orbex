...
import { OrbexPivot } from "@spreadsheet/pivot/orbex_pivot";
...
async function insertStaticPivot(model, pivotId, params) {
    ...
    if (!(ds instanceof OrbexPivot)) {
        throw new Error("The pivot data source is not an OrbexPivot");
    }
 ...
 * @returns {Promise<{ model: OrbexSpreadsheetModel, env: object, pivotId: string}>}
 */
