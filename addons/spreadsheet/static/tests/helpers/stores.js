...
import { stores } from "@orbex/o-spreadsheet";
...
/**
 * @template T
 * @typedef {import("@orbex/o-spreadsheet").StoreConstructor<T>} StoreConstructor<T>
 */
 ...
 * @param  {any[]} args
 * @return {Promise<{ store: T, container: InstanceType<DependencyContainer>, model: OrbexSpreadsheetModel }>}
 */
...
/**
 * @template T
 * @param {import("@orbex/o-spreadsheet").Model} model
 * @param {StoreConstructor<T>} Store
 * @param  {any[]} args
 * @return {{ store: T, container: InstanceType<DependencyContainer>, model: OrbexSpreadsheetModel }}
 */
