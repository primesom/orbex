...
from orbex.addons.base.models.ir_qweb_fields import nl2br
from orbex.addons.mail.tools.discuss import add_guest_to_context, Store
...
class LivechatController(http.Controller):
    ...
    @http.route('/im_livechat/orbex_ui_icons', type='http', auth='none', cors="*")
    def orbex_ui_icons(self, **kwargs):
        return http.Stream.from_path('web/static/lib/orbex_ui_icons/fonts/orbex_ui_icons.woff2').get_response()
