...
from orbex.tools import make_index_name, SQL
from orbex.tools.translate import TranslationImporter
from orbex.tests import standalone
from orbex.addons.account.models.chart_template import AccountChartTemplate
...
def test_all_l10n(env):
    ...
    logger = logging.getLogger('orbex.loading')
