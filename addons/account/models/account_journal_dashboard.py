...
from orbex import models, api, _, fields, tools
from orbex.exceptions import UserError
from orbex.fields import Command, Domain
from orbex.release import version
from orbex.tools import DEFAULT_SERVER_DATE_FORMAT as DF, SQL
from orbex.tools.misc import formatLang, format_date as orbex_format_date, get_lang
...
class AccountJournal(models.Model):
    ...
    def _transform_activity_dict(self, activity_data):
        return {
            ...
            'date': orbex_format_date(self.env, activity_data['date_deadline']),
        }
