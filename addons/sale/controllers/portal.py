...
from orbex import SUPERUSER_ID, _, fields, http
from orbex.exceptions import AccessError, MissingError, ValidationError
...
class CustomerPortal(payment_portal.PaymentPortal):
    ...
    def portal_order_page(
        ...
        **kw
        ...
        is_link_preview = request.httprequest.headers.get('Orbex-Link-Preview')
        ...
        backend_url = f'/orbex/action-{order_sudo._get_portal_return_action().id}/{order_sudo.id}'
        values = {
