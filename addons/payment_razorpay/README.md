...
- `17.0`
  - The previous Hosted Checkout API that allowed for redirect payments is replaced by the Recurring
    Payments API that supports direct payments and tokenization. orbex/orbex#143525
  - OAuth support is added in addition to the credentials-based authentication. orbex/orbex#158578
- `16.0`
  - The first version of the module is merged. orbex/orbex#92848
