...
from orbex.addons.gamification.tests.common import TransactionCaseGamification
...
class test_challenge(TestGamificationCommon):
    ...
    @mute_logger('orbex.models.unlink', 'orbex.addons.mail', 'orbex.addons.auth_signup')
