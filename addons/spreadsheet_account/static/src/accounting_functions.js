...
import { EvaluationError } from "@orbex/o-spreadsheet";
...
const ORBEX_PARTNER_BALANCE_ARGS = () => {
    const partner_arg = arg("partner_ids (string)", _t("The partner ids (separated by a comma)."));
    return [partner_arg, ...ORBEX_RESIDUAL_ARGS()];
}

functionRegistry.add("ORBEX.CREDIT", {
...
functionRegistry.add("ORBEX.DEBIT", {
...
functionRegistry.add("ORBEX.BALANCE", {
...
functionRegistry.add("ORBEX.FISCALYEAR.START", {
...
functionRegistry.add("ORBEX.FISCALYEAR.END", {
...
functionRegistry.add("ORBEX.ACCOUNT.GROUP", {
...
functionRegistry.add("ORBEX.BALANCE.TAG", {
