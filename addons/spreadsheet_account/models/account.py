...
from orbex import models, api, _
from orbex.fields import Domain
from orbex.tools import date_utils
...
class AccountAccount(models.Model):
    ...
    def spreadsheet_fetch_debit_credit(self, args_list):
        """Fetch data for ORBEX.CREDIT, ORBEX.DEBIT and ORBEX.BALANCE formulas
    ...
    def spreadsheet_fetch_residual_amount(self, args_list):
        """Fetch data for ORBEX.RESUDUAL formulas
        The input list looks like this::
    ...
    def spreadsheet_fetch_partner_balance(self, args_list):
        """Fetch data for ORBEX.PARTNER.BALANCE formulas
        The input list looks like this::
    ...
    def spreadsheet_fetch_balance_tag(self, args_list):
        """Fetch data for ORBEX.BALANCE.TAG formulas
        The input list looks like this::
