...
import { animationFrame, click, press, queryOne, waitFor } from "@orbex/hoot-dom";
...
test.tags("desktop");
test("should not open the orbex global command bar when pressing ctrl+k inside a syntax-highlighted code block", async () => {
    ...
    // Pressing ctrl+k to open orbex global command bar
    await press(["ctrl", "k"]);
    await animationFrame();
