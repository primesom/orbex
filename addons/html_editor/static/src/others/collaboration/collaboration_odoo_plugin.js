...
/**
 * @typedef { Object } CollaborationOrbexShared
 * @property { CollaborationOrbexPlugin['getPeerMetadata'] } getPeerMetadata
 */

export class CollaborationOrbexPlugin extends Plugin {
    static id = "collaborationOrbex";
        ...
        return new PeerToPeer({
            ...
            onNotification: async (notification) => {
                ...
                switch (notificationName) {
                    case "ptp_remove":
                        // todo: to implement
                        // this.orbexEditor.multiselectionRemove(notificationPayload);
                        break;
                    case "ptp_disconnect":
                        this.ptp.removePeer(fromPeerId);
                        // todo: to implement
                        // this.orbexEditor.multiselectionRemove(fromPeerId);
                        break;
    ...
    async resetFromServerAndResyncWithPeers() {
        ...
        // lastHistoryId will be different if the orbex bus did not have time to
        // notify the user.
    ...
    showConflictDialog() {
        ...
        //     return;
        // }
        // const content = markup(this.orbexEditor.editable.cloneNode(true).outerHTML);
