...
from orbex.addons.payment.const import CURRENCY_MINOR_UNITS
from orbex.addons.payment.logging import get_payment_logger
from orbex.addons.payment_mercado_pago import const
...
class PaymentTransaction(models.Model):
    ...
    def _apply_updates(self, payment_data):
        ...
        for orbex_code, mp_codes in const.PAYMENT_METHODS_MAPPING.items():
            if any(payment_method_type == mp_code for mp_code in mp_codes.split(',')):
                payment_method_type = orbex_code
                break
        ...
        # the user might have picked a different payment method than on Orbex's payment form.
