...
class MercadoPagoOnboardingController(Controller):
    ...
    def mercado_pago_return_from_authorization(self, **data):
        ...
        # Retrieve the Mercado Pago data and Orbex metadata from the redirect data.
        ...
        redirect_url = f'/orbex/action-{action.id}/{int(provider_sudo.id)}'
