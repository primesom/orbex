...
from orbex.addons.payment_mercado_pago.tests.common import MercadoPagoCommon
...
class TestPaymentTransaction(MercadoPagoCommon, PaymentHttpCommon):
    ...
    def test_no_input_missing_from_redirect_form(self):
        ...
        tx = self._create_transaction(flow='redirect')
        with patch(
            'orbex.addons.payment_mercado_pago.models.payment_transaction.PaymentTransaction'
    ...
    @mute_logger('orbex.addons.payment_mercado_pago.models.payment_transaction')
