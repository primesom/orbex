...
from orbex.tools.pdf import OrbexPdfFileReader, OrbexPdfFileWriter, PdfReadError, DependencyError
    ...
    def _render_qweb_pdf_prepare_streams(self, report_ref, data, res_ids=None):
        ...
        if report.report_name == 'hr_expense.report_expense':
            for expense in self.env['hr.expense'].browse(res_ids):
                ...
                expense_report = OrbexPdfFileReader(stream, strict=False)
                output_pdf = OrbexPdfFileWriter()
                ...
                for attachment in self._prepare_local_attachments(attachments):
                    ...
                    attachment_reader = OrbexPdfFileReader(attachment_stream, strict=False)
                    try:
