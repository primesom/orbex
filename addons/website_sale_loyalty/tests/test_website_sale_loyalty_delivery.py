...
from orbex.addons.base.tests.common import DISABLED_MAIL_CONTEXT
...
from orbex.addons.website_sale_loyalty.controllers.cart import Cart
from orbex.addons.website_sale_loyalty.controllers.delivery import WebsiteSaleLoyaltyDelivery
