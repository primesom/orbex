...
from orbex.addons.crm.tests.test_crm_lead_assignment import TestLeadAssignCommon
...
class TestLeadAssignPerf(TestLeadAssignCommon):
    ...
    @mute_logger('orbex.models.unlink', 'orbex.addons.crm.models.crm_team', 'orbex.addons.crm.models.crm_team_member')
