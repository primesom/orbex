...
from orbex.addons.crm.models.crm_lead import PARTNER_ADDRESS_FIELDS_TO_SYNC
from orbex.addons.mail.tests.common import MailCase, mail_new_test_user
...
from orbex.fields import Datetime
from orbex import models, tools
...
class TestLeadConvertCommon(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.crm_lead_dt_patcher = patch('orbex.addons.crm.models.crm_lead.fields.Datetime', wraps=Datetime)
