...
from orbex.addons.crm.tests.common import TestCrmCommon
from orbex.addons.iap.tools import iap_tools
from orbex.tests.common import tagged, users
...
class TestCRMLead(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.emails_provider_generic = {
            ...
            ('fp@orbexsuite.com', 'fp@orbexsuite.com'),
            ('fp.alias@mail.orbexsuite.com', 'fp.alias@mail.orbexsuite.com'),
        }
        cls.emails_provider_company = {
            ('robert.poilvert@mycompany.com', 'mycompany.com'),
            ('fp@subdomain.orbexsuite.com', 'subdomain.orbexsuite.com'),
        }
        ...
        cls.lead_generic_email_dupes = cls.env['crm.lead'].create([
            ...
            {
                'email_from': '"Fabulous Fab" <fp@ORBEX.COM>',
                'name': 'Dupe1 of fp@orbexsuite.com (same email)',
                'type': 'lead',
            },
            {
                'email_from': 'FP@orbexsuite.com',
                'name': 'Dupe2 of fp@orbexsuite.com (same email)',
                'type': 'lead',
            },
            # phone_sanitized based
            {
                'email_from': 'not.fp@not.orbexsuite.com',
                'name': 'Dupe3 of fp@orbexsuite.com (same phone sanitized)',
                'phone': '+1 202 555 0123',
                'type': 'lead',
            },
            {
                'email_from': 'not.fp@not.orbexsuite.com',
                'phone': '+1 202 555 0123',
                'name': 'Dupe4 of fp@orbexsuite.com (same phone sanitized)',
                'type': 'lead',
            },
            # same commercial entity
            {
                'name': 'Dupe5 of fp@orbexsuite.com (same commercial entity)',
                'partner_id': cls.test_partners[1].id,
            },
            {
                'name': 'Dupe6 of fp@orbexsuite.com (same commercial entity)',
        ...
        cls.lead_generic_email_notdupes = cls.env['crm.lead'].create([
            ...
            {
                'email_from': 'not.fp@orbexsuite.com',
                'name': 'NotADupe1',
                'type': 'lead',
            },
        ])
    ...
    def test_assert_initial_values(self):
        ...
        self.assertEqual(lead_generic.email_domain_criterion, 'fp@orbexsuite.com')
        self.assertEqual(lead_generic.email_normalized, 'fp@orbexsuite.com')
