...
from orbex.addons.crm.tests.common import INCOMING_EMAIL, TestCrmCommon
from orbex.tests import tagged, users
from orbex.tools import email_normalize, formataddr, mute_logger
        ...
        leads = self.env['crm.lead'].create([
            {
                ...
                'partner_id': partner_no_email.id,
                'email_cc': 'test_cc@orbexsuite.com',
                'user_id': self.user_sales_leads.id
            }
        ])
