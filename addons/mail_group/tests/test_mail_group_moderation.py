...
from orbex.addons.mail_group.tests.data import GROUP_TEMPLATE
from orbex.addons.mail_group.tests.common import TestMailListCommon
...
class TestMailGroupModeration(TestMailListCommon):
    ...
    @mute_logger('orbex.models.unlink', 'orbex.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('orbex.addons.base.models.ir_rule', 'orbex.addons.base.models.ir_model')
...
class TestModeration(TestMailListCommon):
    ...
    @mute_logger('orbex.addons.mail.models.mail_thread', 'orbex.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('orbex.addons.mail.models.mail_thread', 'orbex.addons.mail_group.models.mail_group_message', 'orbex.models.unlink')
    @users('employee')
    ...
    @mute_logger('orbex.addons.mail_group.models.mail_group')
    @users('employee')
