...
from orbex import models, fields, api

from orbex.exceptions import ValidationError

from orbex.addons.base_iban.models.res_partner_bank import validate_iban
...
class AccountJournal(models.Model):
    ...
    ], ondelete={'ch': lambda recs: recs.write({'invoice_reference_model': 'orbex'})})
