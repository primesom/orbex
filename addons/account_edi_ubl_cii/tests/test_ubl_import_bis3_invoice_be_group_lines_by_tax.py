from orbex.addons.account_edi_ubl_cii.tests.test_ubl_import_bis3_invoice_be import TestUblImportBis3InvoiceBE
...
class TestUblImportBis3InvoiceBEGroupLinesByTax(TestUblImportBis3InvoiceBE):
    ...
    def test_import_invoice_group_lines_correct_tax_amount(self):
        ...
        # This invoice tax amount computation by orbex is 9.07 while in the XML, the amount is 9.06
