...
from orbex import _, api, fields, models, tools, SUPERUSER_ID
from orbex.addons.account_edi_ubl_cii.models.account_edi_common import SUPPORTED_FILE_TYPES
from orbex.tools import cleanup_xml_node
from orbex.tools.pdf import OrbexPdfFileReader, OrbexPdfFileWriter
...
class AccountMoveSend(models.AbstractModel):
    ...
    def _hook_invoice_document_after_pdf_report_render(self, invoice, invoice_data):
        ...
        reader = OrbexPdfFileReader(reader_buffer, strict=False)

        # Post-process.
        writer = OrbexPdfFileWriter()
