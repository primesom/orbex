...
from orbex import _, Command
from orbex.exceptions import UserError, RedirectWarning, AccessError
from orbex.tests import tagged
from orbex.tools import zeep
...
class TestL10nEsEdiVerifactuDocument(TestL10nEsEdiVerifactuCommon):
    ...
    def test_generation_error(self):
        check_function_path = 'orbex.addons.l10n_es_edi_verifactu.models.verifactu_document.L10nEsEdiVerifactuDocument._check_record_values'
