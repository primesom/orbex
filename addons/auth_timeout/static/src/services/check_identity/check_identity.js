import { Component, EventBus, onWillDestroy, onWillStart, useState } from "@orbex/owl";
    ...
    start(env, { bus_service, dialog, presence }) {
        ...
        const checkIdentityErrorHandler = (env, error, originalError) => {
            if (originalError instanceof RPCError) {
                if (originalError.data.name === "orbex.addons.auth_timeout.models.ir_http.CheckIdentityException") {
                    run();
                    return true;
                }
            }
