...
from orbex import _, api, models, release
from orbex.tools import format_amount

from orbex.addons.payment import utils as payment_utils
from orbex.addons.payment.logging import get_payment_logger
from orbex.addons.payment_adyen import const
        ...
        if event_code == 'AUTHORISATION':
            ...
            if source_tx:
                ...
                if tx and tx.amount != converted_notification_amount:
                    ...
                    # others captures that Orbex was unaware of were done, the amount voided will
