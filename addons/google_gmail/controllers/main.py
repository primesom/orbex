...
from orbex.tools import consteq, email_normalize
from orbex.addons.google_gmail.models.google_gmail_mixin import GMAIL_TOKEN_REQUEST_TIMEOUT
...
class GoogleGmailController(http.Controller):
    ...
    def _get_redirect_url(self, record):
        ...
        if (
            ...
            return f'/orbex/{record._name}/{record.id}'
        return f'/orbex/my-preferences/{request.env.user.id}'
