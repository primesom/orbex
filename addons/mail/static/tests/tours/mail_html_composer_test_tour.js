    ...
    steps: () => [
        {
            ...
            async run() {
                const composerService = orbex.__WOWL_DEBUG__.root.env.services["mail.composer"];
        ...
        },
        {
            ...
            trigger: ".o-mail-Composer-html.orbex-editor-editable",
            run: "editor Hello",
        },
        {
        ...
        },
        {
            ...
            trigger: ".o-mail-Composer-html.orbex-editor-editable strong:contains(Hello)",
        },
        {
        ...
        },
        {
            ...
            trigger: ".o_mail_composer_message .orbex-editor-editable",
            run: "click",
        },
        {
        ...
        },
        {
            ...
            trigger: ".o-mail-Composer-html.orbex-editor-editable em:contains(Hello)",
        },
    ],
});
