...
registry.category("web_tour.tours").add("can_create_channel_from_form_view", {
    steps: () => [
        {
            trigger: ".o-mail-DiscussSidebarChannel-itemName:contains(OrbexBot)",
            run: "click",
        },
        {
            trigger: ".o-mail-DiscussContent-threadName[title='OrbexBot']",
        },
        ...
        {
            trigger: ".breadcrumb-item:contains('OrbexBot')",
            run: "click",
        },
        {
