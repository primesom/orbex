...
import { press } from "@orbex/hoot-dom";
...
test("add_link utility function", () => {
    const testInputs = {
        ...
        "https://www.transifex.com/orbex/orbex-11/translate/#fr/lunch?q=text%3A'La+Tartiflette'": true,
        "https://www.transifex.com/orbex/orbex-11/translate/#fr/$/119303430?q=text%3ATartiflette": true,
        "https://tenor.com/view/chỗgiặt-dog-smile-gif-13860250": true,
        "http://www.boîtenoire.be": true,
        "https://github.com/orbex/enterprise/compare/16.0...orbex-dev:enterprise:16.0-voip-fix_demo_data-tsm?expand=1": true,
        "https://github.com/orbex/enterprise/compare/16.0...16.0-voip-fix_demo_data-tsm?expand=1": true,
        "https://github.com/orbex/enterprise/compare/16.0...chỗgiặt-voip-fix_demo_data-tsm?expand=1": true,
        "https://github.com/orbex/enterprise/compare/chỗgiặt...chỗgiặt-voip-fix_demo_data-tsm?expand=1": true,
        "https://github.com/orbex/enterprise/compare/@...}-voip-fix_demo_data-tsm?expand=1": true,
        "https://x.com": true,
    };
...
test("addLink: utility function and special entities", () => {
    const testInputs = [
        ...
        [
            markup`https://orbexsuite.com/%5B%5D`,
            `<a target="_blank" rel="noreferrer noopener" href="https://orbexsuite.com/%5B%5D">https://orbexsuite.com/%5B%5D</a>`,
        ],
        [
            markup`https://www.orbexsuite.com/appointment/10552?filter_appointment_type_ids=%5B6706%2C%2B6705%2C%2B5292%2C%2B10552%5D`,
            `<a target="_blank" rel="noreferrer noopener" href="https://www.orbexsuite.com/appointment/10552?filter_appointment_type_ids=%5B6706%2C%2B6705%2C%2B5292%2C%2B10552%5D">https://www.orbexsuite.com/appointment/10552?filter_appointment_type_ids=%5B6706%2C%2B6705%2C%2B5292%2C%2B10552%5D</a>`,
        ],
        [
            markup`www.orbexsuite.com`,
            `<a target="_blank" rel="noreferrer noopener" href="http://www.orbexsuite.com/">www.orbexsuite.com</a>`,
        ],
        [
            markup`https://orbexsuite.com/?q=ỗ`,
            `<a target="_blank" rel="noreferrer noopener" href="https://orbexsuite.com/?q=%E1%BB%97">https://orbexsuite.com/?q=ỗ</a>`,
        ],
        ...
        [
            markup`http://999.999.999.999 www.orbexsuite.com`,
            `http://999.999.999.999 <a target="_blank" rel="noreferrer noopener" href="http://www.orbexsuite.com/">www.orbexsuite.com</a>`,
        ],
    ];
...
test("url", async () => {
    ...
    const messageBody = "https://orbexsuite.com?test=~^|`{}[]#";
...
test("url with comma at the end", async () => {
    ...
    await start();
    await openDiscuss(channelId);
    const messageBody = "Go to https://orbexsuite.com, it's great!";
    await insertText(".o-mail-Composer-input", messageBody);
    await press("Enter");
    await contains(".o-mail-Message a:contains(https://orbexsuite.com)");
...
test("url with number in subdomain", async () => {
    ...
    await start();
    await openDiscuss(channelId);
    const messageBody = "https://www.45017478-master-all.runbot134.orbexsuite.com/orbex";
    await insertText(".o-mail-Composer-input", messageBody);
    await press("Enter");
    await contains(
        ".o-mail-Message a:contains(https://www.45017478-master-all.runbot134.orbexsuite.com/orbex)"
    );
});
