...
import { after, before, beforeEach, expect, test } from "@orbex/hoot";
import { press, queryOne } from "@orbex/hoot-dom";
import { animationFrame, enableTransitions } from "@orbex/hoot-mock";
import {
    clickSave,
    contains,
    defineModels,
...
test("HtmlMail save inline html", async function () {
    ...
    await press("enter");
    expect(".orbex-editor-editable").toHaveInnerHTML("<h1> first </h1>");
