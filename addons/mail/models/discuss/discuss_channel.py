...
from orbex import _, api, fields, models, tools, Command
from orbex.addons.base.models.avatar_mixin import get_hsl_from_seed
...
from orbex.addons.mail.tools.web_push import PUSH_NOTIFICATION_TYPE
from orbex.exceptions import AccessError, UserError, ValidationError
from orbex.fields import Domain
from orbex.tools import format_list, email_normalize, html_escape
from orbex.tools.misc import hash_sign, OrderedSet
from orbex.tools.sql import SQL
...
class DiscussChannel(models.Model):
    ...
    def _get_access_action(self, access_uid=None, force_website=False):
        ...
        return {
            "type": "ir.actions.act_url",
            "url": f"/orbex/action-mail.action_discuss?active_id={self.id}",
            "target": "self",
        }
