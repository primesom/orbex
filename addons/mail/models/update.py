...
from orbex import api, fields, release, SUPERUSER_ID
from orbex.exceptions import UserError
from orbex.models import AbstractModel
...
class Publisher_WarrantyContract(AbstractModel):
    ...
    def update_notification(self, cron_mode=True):
        """
        Send a message to Orbex's publisher warranty server to check the
