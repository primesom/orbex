import { reactive } from "@orbex/owl";
...
export class DashboardLoader {
    ...
    _createSpreadsheetModel(snapshot, revisions = [], currency, translationNamespace) {
        const orbexDataProvider = new OrbexDataProvider(this.env);
        const model = new Model(
            snapshot,
            {
                custom: { env: this.env, orm: this.orm, orbexDataProvider, translationNamespace },
                mode: "dashboard",
        ...
        orbexDataProvider.addEventListener("data-source-updated", () =>
