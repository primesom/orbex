...
from orbex.http import root, Request, Response, SessionExpiredException, get_default_session
from orbex.modules.registry import Registry
from orbex.service import model as service_model
from orbex.service.server import CommonServer
from orbex.service.security import check_session
...
class Websocket:
    ...
    def __init__(self, sock, session, cookies):
        ...
        self.__selector = (
            ...
            if orbex.evented and hasattr(selectors, 'PollSelector')
...
class WebsocketConnectionHandler:
    ...
    def _handle_public_configuration(cls, request):
        if not os.getenv('ORBEX_BUS_PUBLIC_SAMESITE_WS'):
            return
