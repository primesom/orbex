...
class L10nHuEdiConnection:
    def __init__(self, env):
        ...
        :param env: the Orbex environment
        """
        self.env = env
    ...
    def do_token_exchange(self, credentials):
        ...
        try:
            # Convert into a naive UTC datetime, since Orbex can't store timezone-aware datetimes
    ...
    def _get_header_values(self, credentials, invoice_hashs=None):
        ...
        request_id = 'ORBEX' + secrets.token_hex(13)
        ...
        return {
            ...
            'softwareName': 'Orbex Enterprise',
            'softwareOperation': 'ONLINE_SERVICE',
            'softwareMainVersion': orbex_version,
            'softwareDevName': 'Orbex SA',
            'softwareDevContact': 'andu@orbexsuite.com',
