...
from orbex import exceptions, fields
from orbex.exceptions import UserError
from orbex.fields import Command
from orbex.tests import Form, HttpCase, freeze_time, tagged
from orbex.tools import float_compare, float_repr, float_round

from orbex.addons.mrp.tests.common import TestMrpCommon
...
class TestBoM(TestMrpCommon):
    ...
    def test_cycle_on_bom_sequencing(self):
        ...
        # (see orbex/addons/web/controllers/main.py:1352)
...
class TestTourBoM(HttpCase):
    ...
    def test_mrp_bom_product_catalog(self):
        ...
        url = f'/orbex/action-mrp.mrp_bom_form_action/{self.bom.id}'
    ...
    def test_manufacture_from_bom(self):
        ...
        """
        url = '/orbex/action-mrp.mrp_bom_form_action'
