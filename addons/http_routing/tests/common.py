...
def MockRequest(
    ...
    request = Mock(
        ...
        type='http',
        future_response=orbex.http.FutureResponse(),
        params={},
        ...
        geoip=orbex.http.GeoIP('127.0.0.1'),
    ...
    if country_code or city_name:
        try:
            request.geoip._city_record = orbex.http.geoip2.models.City(['en'], country=(country_code and {'iso_code': country_code}) or {}, city=(city_name and {'names': {'en': city_name}}) or {})
        except TypeError:
            request.geoip._city_record = orbex.http.geoip2.models.City({'country': (country_code and {'iso_code': country_code}) or {}, 'city': (city_name and {'names': {'en': city_name}}) or {}})
    ...
    #
    #   router = orbex.http.root.get_db_router()
    ...
    with contextlib.ExitStack() as s:
        ...
        s.callback(orbex.http._request_stack.pop)
        s.enter_context(patch('orbex.http.root.get_db_router', router))
