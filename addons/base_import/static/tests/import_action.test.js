import { before, describe, expect, test } from "@orbex/hoot";
import {
    animationFrame,
    drag,
    queryOne,
...
describe("Import view", () => {
    ...
    test("UI before file upload", async () => {
        ...
        expect(browser.location.href).toBe("https://www.hoot.test/orbex/action-2/import");
    ...
    test("open import directlty from URL", async () => {
        ...
        redirect("/orbex/action-2/import");
    ...
    test("drag-and-drop file support", async () => {
        ...
        expect(browser.location.href).toBe(
            "https://www.hoot.test/orbex/action-2/import/imported-records"
        );
    });
    ...
    test("active_model in params is the main model", async () => {
        ...
        expect(browser.location.href).toBe("https://www.hoot.test/orbex/import?active_model=team");
    });
