...
class TestWebsiteCrm(orbex.tests.HttpCase, TestCrmCommon):
    ...
    def test_tour(self):
        ...
        self.assertEqual(record.partner_name, 'Orbex S.A.')
    ...
    def test_catch_logged_partner_info_tour(self):
        ...
        with orbex.tests.RecordCapturer(self.env['crm.lead']) as capt:
