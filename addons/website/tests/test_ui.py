...
from orbex.addons.html_editor.controllers.main import HTML_Editor
from orbex.addons.website.tests.common import HttpCaseWithWebsiteUser
from orbex.fields import Command


@orbex.tests.tagged('-at_install', 'post_install')
class TestUiCustomizeTheme(orbex.tests.HttpCase):
...
class TestUiHtmlEditor(HttpCaseWithUserDemo):
    ...
    def test_code_editor_usable(self):
        ...
        url = '/orbex/action-website.website_preview'
        self.start_tour(url, 'website_code_editor_usable', login='admin')


@orbex.tests.tagged('external', '-standard', '-at_install', 'post_install')
...
@orbex.tests.tagged('-at_install', 'post_install')
class TestUiTranslate(orbex.tests.HttpCase):
...
class TestUi(HttpCaseWithWebsiteUser):
    ...
    def test_01_admin_tour_homepage(self):
        self.start_tour("/orbex", 'homepage', login='admin')
    ...
    def test_10_website_conditional_visibility(self):
        ...
        self.start_tour('/orbex', 'conditional_visibility_2', login='website_user')
    ...
    def test_19_website_page_options(self):
        self.start_tour("/orbex", "website_page_options", login="admin")
    ...
    def test_21_website_start_cloned_snippet(self):
        self.start_tour('/orbex', 'website_start_cloned_snippet', login='admin')

    def test_22_website_gray_color_palette(self):
        self.start_tour('/orbex', 'website_gray_color_palette', login='admin')
    ...
    def test_26_website_media_dialog_icons(self):
        self.env.ref('website.default_website').write({
            'social_twitter': 'https://twitter.com/Orbex',
            'social_facebook': 'https://www.facebook.com/Orbex',
            'social_linkedin': 'https://www.linkedin.com/company/orbex',
            'social_youtube': 'https://www.youtube.com/user/OpenERPonline',
            'social_github': 'https://github.com/orbex',
            'social_instagram': 'https://www.instagram.com/explore/tags/orbex/',
            'social_tiktok': 'https://www.tiktok.com/@orbex',
    ...
    def test_27_website_clicks(self):
        self.start_tour('/orbex', 'website_click_tour', login='admin')
    ...
    def test_33_website_menus(self):
        ...
        self.start_tour("/orbex/action-website.action_website_menu", "parent_child_menu", login="admin")
