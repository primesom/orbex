...
registerWebsitePreviewTour(
    ...
    () => [
        ...
        ...addNewSocialNetwork(10, 9, "https://instagr.am/orbex.official/"),
        {
            ...
            trigger:
                ...
                ":has(a:eq(9)[href='https://instagr.am/orbex.official/']:has(i.fa-instagram))",
        },
        ...
        },
        {
            ...
            run: "edit https://instagram.com/orbex.official/ && click body",
        },
        ...preventRaceConditionStep,
        ...clickOnSave(),
        ...clickOnEditAndWaitEditMode(),
