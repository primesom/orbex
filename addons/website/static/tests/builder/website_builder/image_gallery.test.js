...
import { animationFrame, click, queryAll, queryOne, waitFor } from "@orbex/hoot-dom";
...
test("Change gallery layout when images have a link", async () => {
    ...
    expect(":iframe section a[href='http://orbexsuite.com'] > img[data-index='1']").toHaveCount(1);
