 ...
 * corner to provide the authenticated user an access to his orbex backend.
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (!window.frameElement) {
        ...
        // - Having an event that's fire only when the page is from Orbex avoids
        //   weird behaviours. (e.g. if we want to clear out the iframe, it might
        //   fire an DOMContentLoaded on a non orbex page)
        window.frameElement.dispatchEvent(new CustomEvent("OrbexFrameContentLoaded"));
    }
});
