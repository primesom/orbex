...
from orbex import api, fields, models, tools, release
from orbex.addons.website.models.ir_http import sitemap_qs2dom
from orbex.addons.website.tools import similarity_score, text_from_html, get_base_domain
from orbex.addons.portal.controllers.portal import pager
...
from orbex.tools import SQL, Query
from orbex.tools.image import image_process
from orbex.tools.sql import escape_psql
...
DEFAULT_WEBSITE_ENDPOINT = 'https://website.api.orbexsuite.com'
DEFAULT_OLG_ENDPOINT = 'https://olg.api.orbexsuite.com'
...
class Website(models.Model):
        ...
        for model_name, field_name in self._get_html_fields():
            ...
            if dependency_records:
                ...
                dependencies[model_display_name] += [{
                    ...
                    'link': 'website_url' in rec and rec.website_url or f'/orbex/{model_name}/{rec.id}',
    ...
    def get_website_page_ids(self):
        ...
        if not self.env.user.has_group('website.group_website_restricted_editor'):
            ...
            # (website.page) can't be access. It's how the Orbex framework works.
    ...
    def get_client_action_url(self, url, mode_edit=False, mode_debug=0):
        ...
        return "/orbex/action-website.website_preview?" + urls.url_encode(action_params)
