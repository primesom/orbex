...
from orbex import Command, api, fields, models
from orbex.exceptions import UserError
from orbex.tools import float_compare, float_is_zero, float_repr, OrderedSet
...
class AccountMove(models.Model):
    ...
    def _l10n_pl_edi_get_status_mapping(self):
        """
        Returns a dictionary mapping KSeF status codes to (orbex_status, message).
        """
        return {
