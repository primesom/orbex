    ...
    */
    ...
    _call_viva_com(data, action, paymentLine) {
        return this.env.services.orm.silent
            ...
            .catch(this._handleOrbexConnectionFailure.bind(this, paymentLine));
    }

    _handleOrbexConnectionFailure(paymentLine, data = {}) {
        // handle timeout
        ...
        this._show_error(
            _t(
                "Could not connect to the Orbex server, please check your internet connection and try again."
            )
        );
    ...
    handleVivaComStatusResponse(paymentLine, notification) {
        if (!notification) {
            this._handleOrbexConnectionFailure(paymentLine);
            return;
        }
        ...
        return new Promise((resolve) => {
            ...
            const intervalId = setInterval(async () => {
                ...
                try {
                    ...
                    // so that _handleOrbexConnectionFailure is NOT triggered
