...
from orbex.addons.point_of_sale.tests.test_frontend import TestPointOfSaleHttpCommon
from orbex.addons.mail.tests.common import mail_new_test_user
from orbex.addons.pos_online_payment.tests.online_payment_common import OnlinePaymentCommon
from orbex.addons.account.models.account_payment_method import AccountPaymentMethod
from orbex.addons.point_of_sale.tests.common import archive_products
...
class TestUi(TestPointOfSaleHttpCommon, OnlinePaymentCommon):
    ...
    def test_invalid_access_token(self):
        ...
        with mute_logger('orbex.http'): # Mutes "The provided order or access token is invalid." online payment portal error.
