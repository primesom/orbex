...
import { animationFrame, tick, waitFor, waitUntil } from "@orbex/hoot-dom";
import { Deferred } from "@orbex/hoot-mock";
import { MainComponentsContainer } from "@web/core/main_components_container";
import { patch } from "@web/core/utils/patch";
import { onMounted } from "@orbex/owl";
import { expect } from "@orbex/hoot";
...
export const setupPosEnv = async (opts = { setupCashier: true }) => {
    ...
    orbex.pos_session_id = 1;
    orbex.pos_config_id = 1;
    orbex.from_backend = 0;
    orbex.access_token = uuidv4(); // Avoid indexedDB conflicts
    orbex.info = {
