import { Component, onWillStart } from "@orbex/owl";
...
export class TestEPos extends Component {
    ...
    setup() {
        ...
        onWillStart(async () => {
            orbex.use_lna = (await this.orm.call("pos.printer", "use_local_network_access")).use_lna;
        });
    }
    ...
    async onClick() {
        try {
            ...
            const protocol = orbex.use_lna ? "http:" : window.location.protocol;
