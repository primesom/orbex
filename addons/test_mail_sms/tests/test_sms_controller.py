...
from orbex.addons.test_mail_sms.tests.test_sms_management import TestSMSActionsCommon
...
class TestSmsController(TestSMSActionsCommon):
    ...
    @mute_logger("orbex.addons.base.models.ir_http")
    ...
    @mute_logger('orbex.addons.base.models.ir_http', 'orbex.addons.sms.controllers.main', 'orbex.http')
