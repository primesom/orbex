...
from orbex import api, models, fields
from orbex.tools import _, LazyTranslate, hash_sign
from orbex.exceptions import ValidationError, UserError
from orbex.addons.base.models.res_partner import EU_EXTRA_VAT_CODES
...
class ResPartner(models.Model):
    ...
    def _get_iap_vies_endpoint(self):
        prod, test = 'https://vies.api.orbexsuite.com', 'https://vies.test.orbexsuite.com'
