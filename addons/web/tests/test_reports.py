...
class TestReports(orbex.tests.HttpCase):
    def test_report_session_cookie(self):
        """ Asserts wkhtmltopdf forwards the user session when requesting resources to Orbex, such as images,
    ...
    @mute_logger('orbex.addons.base.models.ir_actions_report')
