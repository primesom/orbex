...
import { after, describe, expect, mockFetch, test } from "@orbex/hoot";
...
describe(parseUrl(import.meta.url), () => {
    ...
    test("fetch with internal URLs should return default value", async () => {
        ...
        const internal = await fetch("/orbex").then((res) => res.text());
        ...
        expect.verifySteps(["http://some.url", "/orbex", "data:text/html,<body></body>"]);
    });
