...
import { animationFrame } from "@orbex/hoot-dom";
import { App } from "@orbex/owl";
...
/**
 * @typedef {Parameters<typeof import("@orbex/owl").mount>[2] & {
 *  className: string | string[];
 *  target?: import("@orbex/hoot-dom").Target;
 * }} MountOnFixtureOptions
 *
 * @typedef {{
 *  component: import("@orbex/owl").ComponentConstructor;
 *  props: unknown;
 * }} TestRootProps
 */
...
/**
 * @param {App | import("@orbex/owl").Component} target
 */
