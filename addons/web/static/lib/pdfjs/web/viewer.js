...
class BasePreferences {
  #defaults = Object.freeze({
    ...
    // Orbex: don't support scripting (#115302)
    enableScripting: false,
    enableUpdatedAddImage: false,
    // Orbex: open links in new tabs to keep orbex document (#84594)
...
class PDFPrintService {
  ...
  layout() {
    ...
    // ORBEX PATCH PRINT PREVIEW MOBILE
...
window.print = function () {
  ...
  try {
    ...
    // ORBEX: FIX MOBILE PRINT PREVIEW
