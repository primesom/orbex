import { getFixture, after } from "@orbex/hoot";
...
export async function startInteractions(
    ...
    if (orbex.loader.modules.has("@mail/../tests/mail_test_helpers")) {
        const { defineMailModels } = orbex.loader.modules.get("@mail/../tests/mail_test_helpers");
        defineMailModels();
    }
