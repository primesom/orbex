import { test, expect } from "@orbex/hoot";
import { press, click, animationFrame, queryOne, manuallyDispatchProgrammaticEvent } from "@orbex/hoot-dom";
import { Component, xml, useState } from "@orbex/owl";
