/** @orbex-module alias=@web/../tests/mobile/core/action_swiper_tests default=false */

import { beforeEach, expect, test } from "@orbex/hoot";
import { hover, queryFirst } from "@orbex/hoot-dom";
import { advanceTime, animationFrame, mockTouch } from "@orbex/hoot-mock";
import { Component, onPatched, xml } from "@orbex/owl";
import {
    contains,
    defineParams,
    mountWithCleanup,
