import { describe, destroy, expect, getFixture, test } from "@orbex/hoot";
import { click, tick } from "@orbex/hoot-dom";
import { Deferred, advanceTime, animationFrame, microTick, runAllTimers } from "@orbex/hoot-mock";
