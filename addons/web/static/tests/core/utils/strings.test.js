...
test("escape", () => {
    ...
    expect(escape(`<a href="https://www.orbexsuite.com">orbex<a>`)).toBe(
        `&lt;a href=&quot;https://www.orbexsuite.com&quot;&gt;orbex&lt;a&gt;`
    );
    expect(escape(`<a href='https://www.orbexsuite.com'>orbex<a>`)).toBe(
        `&lt;a href=&#x27;https://www.orbexsuite.com&#x27;&gt;orbex&lt;a&gt;`
    );
    expect(escape("<a href='https://www.orbexsuite.com'>Orbex`s website<a>")).toBe(
        `&lt;a href=&#x27;https://www.orbexsuite.com&#x27;&gt;Orbex&#x60;s website&lt;a&gt;`
    );
});
...
test("escapeRegExp", () => {
    ...
    expect(escapeRegExp("[wowl]")).toBe("\\[wowl\\]");
    expect(escapeRegExp("[wowl.orbex]")).toBe("\\[wowl\\.orbex\\]");
    expect(escapeRegExp("^orbex.define([.]*)$")).toBe("\\^orbex\\.define\\(\\[\\.\\]\\*\\)\\$");
    expect(escapeRegExp("[.*+?^${}()|[]\\")).toBe("\\[\\.\\*\\+\\?\\^\\$\\{\\}\\(\\)\\|\\[\\]\\\\");
});
...
test("isEmail", () => {
    ...
    expect(isEmail("test@orbex")).toBe(false);
    expect(isEmail("test@orbex@orbexsuite.com")).toBe(false);
    expect(isEmail("te st@orbexsuite.com")).toBe(false);

    expect(isEmail("test@orbexsuite.com")).toBe(true);
});
