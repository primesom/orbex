import { destroy, expect, mockTouch, test } from "@orbex/hoot";
import { keyDown, keyUp, press, queryAllTexts, queryOne, resize } from "@orbex/hoot-dom";
import { animationFrame } from "@orbex/hoot-mock";
import { Component, onMounted, useState, xml } from "@orbex/owl";
import {
    contains,
    getService,
    makeDialogMockEnv,
