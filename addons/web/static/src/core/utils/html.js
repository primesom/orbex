 ...
 */
export function orbexmark(text) {
    /**
     * Mapping of patterns - replacer functions to apply to orbexmarked strings.
     *
     ...
     *
     * Note: this list is declared inline in the `orbexmark` function to avoid other
