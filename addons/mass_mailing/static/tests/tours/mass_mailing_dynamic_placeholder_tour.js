    ...
    steps: () => [
        ...
        },
        {
        ...
        },
         {
            ...
            trigger: ":iframe .orbex-editor-editable .o_mail_no_options",
            async run(actions) {
        ...
        },
        {
            ...
            trigger: `:iframe .note-editable.orbex-editor-editable t[t-out="object.company_name"]:contains("defValue")`,
        },
        {
