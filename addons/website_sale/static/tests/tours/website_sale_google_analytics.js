...
function patchTracking() {
    const { Tracking } = orbex.loader.modules.get('@website_sale/interactions/tracking');
...
if (orbex.loader.modules.has('@website_sale/interactions/tracking')) {
    patchTracking();
} else {
    orbex.loader.bus.addEventListener('module-started', (e) => {
