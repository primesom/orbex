...
from orbex.tools import SQL, clean_context, float_round, groupby, lazy, str2bool
from orbex.tools.json import scriptsafe as json_scriptsafe
from orbex.tools.translate import LazyTranslate, _
...
from orbex.addons.sale.controllers import portal as sale_portal
from orbex.addons.html_editor.tools import get_video_thumbnail
from orbex.addons.website.controllers.main import QueryURL
from orbex.addons.website.models.ir_http import sitemap_qs2dom
from orbex.addons.website_sale.const import SHOP_PATH
from orbex.addons.website_sale.models.website import (
...
def handle_product_params_error(exc, product, category=None, **kwargs):
    ...
    :param orbex.exceptions.AccessError | orbex.exceptions.MissingError exc: The exception thrown
...
class WebsiteSale(payment_portal.PaymentPortal):
    ...
    def add_product_media(self, media, type, product_product_id, product_template_id, combination_ids=None):
        ...
        if type == 'image':  # Image case
            ...
            media_create_data = [Command.create({
                'name': video_data.get('name', 'Orbex Video'),
