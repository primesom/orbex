...
from orbex import SUPERUSER_ID, api, fields, models
from orbex.exceptions import ValidationError
from orbex.fields import Domain
from orbex.http import request
from orbex.tools import float_is_zero, float_round, urls

from orbex.addons.website_sale import const, utils
...
class ProductFeed(models.Model):
    ...
    def _prepare_gmc_price_info(self, product):
        ...
        # differently than Orbex.
        # Ex: product="Pack of wine (6 bottles)", price=$65.00, uom_name="Pack".
        #   - in orbex: base_unit_count=6.0, base_unit_name="750ml"
    ...
    def _notify_website_manager(self, **kwargs):
        """Send a notification to the website manager using OrbexBot.
