...
from orbex.addons.google_calendar.tests.test_sync_common import TestSyncGoogle
...
@tagged('orbex2google')
class TestSyncOrbex2GoogleMail(TestTokenAccess, TestSyncGoogle, MailCommon):
