...
from orbex import _, api, Command, fields, models, tools
...
from orbex.tools import format_date, format_datetime, format_time, frozendict
from orbex.tools.mail import is_html_empty, html_to_inner_content
from orbex.tools.misc import formatLang
...
class EventEvent(models.Model):
    ...
    def get_kiosk_url(self):
        return self.get_base_url() + "/orbex/registration-desk"
