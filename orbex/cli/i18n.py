...
from orbex.modules import get_module_path
from orbex.modules.registry import Registry
from orbex.tools import OrderedSet, config
from orbex.tools.translate import TranslationImporter, load_language, trans_export
    ...
    def __init__(self, *args, **kwargs):
        ...
        for parser in (self.import_parser, self.export_parser, self.loadlang_parser):
            ...
            parser.epilog = textwrap.dedent("""\
                ...
                Examples:
                    orbex-bin i18n loadlang -l en         # English (U.S.)
                    orbex-bin i18n loadlang -l es es_AR   # Spanish (Spain, Argentina)
                    orbex-bin i18n loadlang -l sr@latin   # Serbian (Latin)
            """)
