...
from orbex.tools.mimetypes import _orbex_guess_mimetype, guess_mimetype
...
class TestMimeGuessingOrbex(BaseCase, MimeGuessingCases):
    guess_mimetype = staticmethod(_orbex_guess_mimetype)
...
@unittest.skipIf(guess_mimetype is _orbex_guess_mimetype, "python-magic not installed")
