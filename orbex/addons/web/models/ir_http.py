...
from orbex.http import request, DEFAULT_MAX_CONTENT_LENGTH
from orbex.tools import config
from orbex.tools.misc import hmac, str2bool
...
class IrHttp(models.AbstractModel):
    ...
    def session_info(self):
        ...
        version_info = orbex.service.common.exp_version()
        ...
        session_info = {
            ...
            "support_url": "https://www.orbexsuite.com/buy",
            "name": user.name,
            "username": user.login,
