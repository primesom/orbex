...
import { PromoteStudioAutomationDialog } from "@web/enterprise/webclient/promote_studio/promote_studio_dialog";
    ...
    async openAutomations() {
        if (typeof this._openAutomations === "function") {
            ...
            this.env.services.dialog.add(PromoteStudioAutomationDialog, {
                title: _t("orbex Studio - Customize workflows in minutes"),
            });
        }
    },
});
