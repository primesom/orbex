...
export class NavBar extends Component {
    ...
    setup() {
        ...
        this.state = useState({
            ...
            isAppSidebarCollapsed: window.localStorage.getItem("orbex_sidebar_collapsed") === "1",
    ...
    get isDiscussApp() {
        return (
            this.currentApp?.xmlid?.startsWith("mail.") ||
            ["Discuss", "Chat", "Channels", "Call History"].includes(this.currentApp?.name)
        );
    }
    ...
    toggleAppSidebar() {
        this.state.isAppSidebarCollapsed = !this.state.isAppSidebarCollapsed;
