...
import { Component, useRef, useSubEnv } from "@orbex/owl";
 ...
 * It uses a feature to automatically create links to other orbex pages if the selector [res-id][res-model][view-type]
 * is detected.
 */
