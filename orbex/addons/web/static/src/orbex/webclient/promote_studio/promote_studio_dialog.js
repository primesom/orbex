...
import { Component, useExternalListener } from "@orbex/owl";

export class PromoteStudioDialog extends Component {
    static template = "web_orbex.PromoteStudioDialog";
...
export class PromoteStudioAutomationDialog extends PromoteStudioDialog {
    static template = "web_orbex.PromoteStudioAutomationDialog";
}
