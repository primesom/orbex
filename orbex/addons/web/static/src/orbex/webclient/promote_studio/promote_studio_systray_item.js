...
import { PromoteStudioDialog } from "@web/orbex/webclient/promote_studio/promote_studio_dialog";
import { _t } from "@web/core/l10n/translation";

import { Component } from "@orbex/owl";

export class PromoteStudioSystrayItem extends Component {
    static template = "web_orbex.SystrayItem";
    static props = {};
    ...
    _onClick() {
        this.dialog.add(PromoteStudioDialog, {
            title: _t("orbex Studio - Add new fields to any view"),
        });
    }
}
