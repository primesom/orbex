...
export class ViewButton extends Component {
    ...
    get hasBigTooltip() {
        return Boolean(orbex.debug) || this.clickParams.help;
    }
    ...
    getClassName() {
        ...
        if (this.props.className) {
            for (let cls of this.props.className.split(" ")) {
                if (cls in orbexToBootstrapClasses) {
                    cls = orbexToBootstrapClasses[cls];
                }
                classNames.push(cls);
