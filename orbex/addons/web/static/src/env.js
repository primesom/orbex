import { App, EventBus } from "@orbex/owl";
...
/**
 * Return a value Orbex Env object
 *
 * @returns {OrbexEnv}
 */
 ...
 * in `__WOWL_DEBUG__`
 *
 * @param {import("@orbex/owl").Component} component the component to mount
