import { destroy, expect, getFixture, onError, test } from "@orbex/hoot";
import { keyDown, keyUp, press, queryAllTexts, queryOne } from "@orbex/hoot-dom";
import { animationFrame, mockUserAgent, tick } from "@orbex/hoot-mock";
import { Component, useRef, useState, xml } from "@orbex/owl";
import {
    contains,
    getService,
    makeMockEnv,
