...
import { click, queryAllAttributes, queryAllProperties, queryAllTexts } from "@orbex/hoot-dom";
...
test("click on orbex account item", async () => {
    ...
    expect(".o-dropdown--menu .dropdown-item").toHaveText("My orbexsuite.com Account");
