/** @orbex-module alias=@web/../tests/setup default=false */
...
import { App, EventBus, whenReady } from "@orbex/owl";
...
function makeMockLocation() {
    return Object.assign(document.createElement("a"), {
        href: window.location.origin + "/orbex",
        assign(url) {
            this.href = url;
        },
        reload() {},
...
function patchSessionInfo() {
    patchWithCleanup(sessionInfo, {
        ...
        is_admin: true,
        is_system: true,
        username: "thewise@orbexsuite.com",
        name: "Mitchell",
        partner_id: 7,
        uid: 7,
        server_version: "1.0",
