/** @orbex-module alias=@web/../tests/qunit default=false */
...
import { Component, whenReady } from "@orbex/owl";
...
export function setupQUnit() {
    ...
    QUnit.done(async (result) => {
        await orbex.loader.checkErrorProm;
    ...
    QUnit.begin(function () {
        if (orbex.debug && orbex.debug.includes("assets")) {
    ...
    QUnit.on("OrbexAfterTestHook", (info) => {
