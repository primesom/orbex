import { after, destroy, getFixture, queryFirst, queryOne } from "@orbex/hoot";
import { App, Component, xml } from "@orbex/owl";
 ...
 * @typedef {import("@orbex/owl").Component} Component
 ...
 * @template [P=any]
 * @template [E=any]
 * @typedef {import("@orbex/owl").ComponentConstructor<P, E>} ComponentConstructor
 */
 ...
 * @param {AppConfig & {
 *  componentEnv?: Partial<OrbexEnv>;
 *  containerEnv?: Partial<OrbexEnv>;
