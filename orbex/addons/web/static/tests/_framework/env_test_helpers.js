import { after, afterEach, beforeEach, registerDebugInfo } from "@orbex/hoot";
 ...
 *
 * @param {Partial<OrbexEnv>} [partialEnv]
 * @param {{
 *  makeNew?: boolean;
 * }} [options]
 */
 ...
 *  (env: OrbexEnv, dependencies: Dependencies) => Services[T]
 * } serviceFactory
 */
