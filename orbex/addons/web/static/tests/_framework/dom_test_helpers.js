...
/**
 * @typedef {import("@orbex/hoot").DragHelpers} DragHelpers
 * @typedef {import("@orbex/hoot").DragOptions} DragOptions
 * @typedef {import("@orbex/hoot").FillOptions} FillOptions
 * @typedef {import("@orbex/hoot").InputValue} InputValue
 * @typedef {import("@orbex/hoot").KeyStrokes} KeyStrokes
 * @typedef {import("@orbex/hoot").PointerOptions} PointerOptions
 * @typedef {import("@orbex/hoot").Position} Position
 * @typedef {import("@orbex/hoot").QueryOptions} QueryOptions
 * @typedef {import("@orbex/hoot").Target} Target
 *
 * @typedef {DragOptions & {
