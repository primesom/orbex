...
class ModuleSetLoader extends loader.constructor {
    ...
    constructor(moduleSet) {
        ...
        orbex.define = this.define.bind(this);
        orbex.loader = this;
    }
...
const AUTO_INCLUDED_ADDONS = {
    /**
     * spreadsheet addons defines a module that does not starts with `@spreadsheet` but `@orbex` (`@orbex/o-spreadsheet)
...
const R_DEFAULT_MODULE = /^@orbex\/(owl|hoot)/;
