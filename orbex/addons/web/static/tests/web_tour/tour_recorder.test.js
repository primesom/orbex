...
import { click, edit, keyDown, keyUp, press, queryOne } from "@orbex/hoot-dom";
import { animationFrame, runAllTimers } from "@orbex/hoot-mock";
import {
    contains,
    defineWebModels,
    mountWithCleanup,
...
import { TourRecorder } from "@web/web_tour/js/tour_recorder/tour_recorder";
import {
...
test("Click on element with unique orbex class", async () => {
...
test("Click on element with no unique orbex class", async () => {
    await mountWithCleanup(
        `
        <div class="o_parent">
            <div class="o_child_1 click"></div>
...
test("Find the nearest orbex class", async () => {
