...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("OrbexBeforeTestHook", "OrbexAfterTestHook"); // Orbex customization
  ...
  Test.prototype = {
  	...
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("OrbexBeforeTestHook"); // Orbex customization
