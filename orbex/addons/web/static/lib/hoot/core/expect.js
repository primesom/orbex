 ...
 *
 * @typedef {import("@orbex/hoot-dom").Dimensions} Dimensions
 * @typedef {import("@orbex/hoot-dom").FormatXmlOptions} FormatXmlOptions
 ...
 * @typedef {import("@orbex/hoot-dom").QueryRectOptions} QueryRectOptions
 * @typedef {import("@orbex/hoot-dom").QueryTextOptions} QueryTextOptions
 * @typedef {import("@orbex/hoot-dom").Target} Target
 */
...
export class Matcher {
     ...
     * @example
     *  expect("header h1").toHaveText(/orbex/i);
     */
