from orbex import api, Command
from orbex.tests.common import HttpCase, tagged
from orbex.addons.base.tests.common import new_test_user
...
class TestWebOrbex(HttpCase):
    def test_studio_list_upsell(self):
        ...
        if not invoice_action:
            return
        self.start_tour("/orbex/action-account.action_move_out_invoice_type", "web_orbex.test_studio_list_upsell", login="admin")
    ...
    def test_studio_no_list_upsell_if_blacklisted(self):
        ...
        if not knowledge_action:
            return
        self.start_tour("/orbex/action-knowledge.knowledge_article_action", "web_orbex.test_studio_no_list_upsell_if_blacklisted", login="admin")
