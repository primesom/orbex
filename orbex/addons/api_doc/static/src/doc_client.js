import { Component, useState, onMounted, useSubEnv } from "@orbex/owl";
...
export class DocClient extends Component {
    ...
    setup() {
        this.setTheme(localStorage.getItem("theme") || "orbex-dark");
    ...
    toggleTheme() {
        this.setTheme(this.theme === "orbex-dark" ? "orbex-light" : "orbex-dark");
    }
