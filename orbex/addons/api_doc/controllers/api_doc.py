...
from orbex.http import content_disposition, request
from orbex.modules.module_graph import ModuleGraph
from orbex.service.model import get_public_method
from orbex.tools import hmac, json_default, lazy_classproperty, py_to_js_locale
...
class DocController(http.Controller):
    ...
    def doc_index(self):
        ...
        if parse_cache_control_header(request.httprequest.headers.get('Cache-Control')).no_cache:
            ...
            return request.make_json_response(
                ...
                headers={
                    ...
                    'Content-Disposition': content_disposition('orbex-doc-index.json'),
        ...
        filename = f'orbex-doc-index-{db_registry_sequence}-{unique}.json'
...
DOC_API_MAGIC_COLUMNS = list(orbex.models.MAGIC_COLUMNS)
...
# works much better than orbex.tools.lazy.
class _DocUtils:
