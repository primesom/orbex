...
from orbex.tests import BaseCase, TransactionCase, tagged, BaseCase
from orbex.tests.suite import _logger as test_logger
...
class TestRetry(TestRetryCommon):
    """ Check some tests behaviour when ORBEX_TEST_FAILURE_RETRIES is set"""
