...
from orbex.tests.common import BaseCase, TransactionCase, tagged, new_test_user, HttpCase
from orbex.tools import profiler
from orbex.tools.profiler import Profiler, ExecutionContext
from orbex.tools.speedscope import Speedscope
...
class TestProfiling(TransactionCase):
    ...
    def test_profiler_return(self):
        ...
        self.startClassPatcher(patch('orbex.sql_db.db_connect', return_value=self.registry))
