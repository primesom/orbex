...
from orbex.tests.common import BaseCase, HttpCase
from orbex.tests.test_cursor import TestCursor
from orbex.tools.misc import config
...
class TestTestCursor(common.TransactionCase):
    ...
    def test_interleaving(self):
        ...
        with self.assertLogs('orbex.sql_db', level=logging.WARNING) as cm:
            a.close()
        [msg] = cm.output
        self.assertIn('WARNING:orbex.sql_db:Found different un-closed cursor', msg)
