...
from orbex.tools.pdf.signature import PdfSigner
...
class TestSignature(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cert_subject = x509.Name([
            ...
            x509.NameAttribute(NameOID.ORGANIZATION_NAME, "Orbex"),
            x509.NameAttribute(NameOID.COMMON_NAME, "orbexsuite.com")
        ])
    ...
    def test_orbex_pdf_signer(self):
