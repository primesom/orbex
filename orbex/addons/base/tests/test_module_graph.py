...
class TestGraph(BaseCase):
    @mute_logger('orbex.modules.module_graph')
    def _test_graph_order(
        ...
        with (
            patch('orbex.modules.module_graph.ModuleGraph._update_from_database'),
            patch('orbex.modules.module_graph.Manifest.for_addon', make_manifest),
            patch('orbex.modules.module_graph.ModuleGraph._imported_modules', {'studio_customization'}),
        ):
            dummy_cr = None
