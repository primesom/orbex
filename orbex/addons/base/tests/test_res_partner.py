...
from orbex import Command, models
from orbex.addons.base.models.ir_mail_server import extract_rfc2822_addresses
from orbex.addons.base.models.res_partner import ResPartner
from orbex.addons.base.tests.common import TransactionCaseWithUserDemo
from orbex.exceptions import AccessError, RedirectWarning, UserError, ValidationError
from orbex.tests import Form
from orbex.tests.common import new_test_user, tagged, TransactionCase, users
...
class TestPartner(TransactionCaseWithUserDemo):
    ...
    def test_main_user_id(self):
        """Test main_user_id compute, including OrbexBot special case and priority among several users."""
