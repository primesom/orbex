...
from orbex.tests.common import standalone
from orbex.tests.test_module_operations import install
from orbex.tools import mute_logger
from orbex.tools.convert import ParseError
...
def test_isolated_install(env):
    ...
    try:
        with mute_logger('orbex.modules.registry'):
