...
from orbex.tools.misc import topological_sort, get_flag
from orbex.tools.translate import TranslationImporter, get_po_paths, get_datafile_translation_path
from orbex.http import request
from orbex.modules.module import Manifest, MissingDependency
...
class IrModuleModule(models.Model):
    ...
    def _button_immediate_function(self, function):
        ...
        if self.search_count([('state', 'in', ('to install', 'to upgrade', 'to remove'))], limit=1):
            raise UserError(_("Orbex is currently processing another module operation.\n"
        ...
        try:
            ...
            raise UserError(_("Orbex is currently processing a scheduled action.\n"
    ...
    def button_uninstall(self):
        un_installable_modules = set(orbex.tools.config['server_wide_modules']) & set(self.mapped('name'))
