...
from orbex.tools import _, frozendict, get_lang
from orbex.tools.float_utils import float_compare
from orbex.tools.misc import get_diff, unquote
from orbex.tools.safe_eval import safe_eval, test_python_expr
...
class IrActionsServer(models.Model):
    ...
    Since Orbex 8.0 a button 'Create Menu Action' button is available on the
