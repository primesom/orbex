...
from orbex.http import ROUTING_KEYS, SAFE_HTTP_METHODS, Response, request
from orbex.modules.registry import Registry
from orbex.service import security
from orbex.tools.json import json_default
from orbex.tools.misc import get_lang, submap
from orbex.tools.translate import code_translations

_logger = logging.getLogger(__name__)

# see also mimetypes module: https://docs.python.org/3/library/mimetypes.html and orbex.tools.mimetypes
...
class IrHttp(models.AbstractModel):
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        for key, val in list(args.items()):
            ...
            try:
            ...
            except (orbex.exceptions.AccessError, orbex.exceptions.MissingError) as e:
                ...
                if request.env.user.is_public or isinstance(e, orbex.exceptions.MissingError):
    ...
    def routing_map(self, key=None):
        ...
        installed = registry._init_modules.union(orbex.tools.config['server_wide_modules'])
    ...
    def _gc_sessions(self):
        if os.getenv("ORBEX_SKIP_GC_SESSIONS"):
            return
