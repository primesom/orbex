...
from orbex.exceptions import MissingError, UserError
from orbex.http import Stream, request
from orbex.tools import file_open, replace_exceptions
from orbex.tools.image import image_guess_size_from_field_name, image_process
from orbex.tools.mimetypes import MIMETYPE_HEAD_SIZE, get_extension, guess_mimetype
from orbex.tools.misc import verify_limited_field_access_token
...
class IrBinary(models.AbstractModel):
    ...
    def _get_stream_from(
        ...
        """
        Create a :class:orbex.http.Stream: from a record's binary field.
    ...
    def _get_image_stream_from(
        ...
        :meth:`~orbex.models.BaseModel._get_placeholder_filename` which
        ...
        accordingly. See also :func:`orbex.tools.image.image_process`.
