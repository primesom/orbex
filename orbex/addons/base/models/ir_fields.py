...
from orbex import api, Command, fields, models
from orbex.tools import OrderedSet
from orbex.tools.translate import _, code_translations, LazyTranslate
...
class IrFieldsConverter(models.AbstractModel):
    ...
    def for_model(self, model, fromtype=str, *, savepoint):
        ...
        callable taking a record-ish (a dictionary representing an orbex
        record with values of typetag ``fromtype``) and returning a converted
        records matching what :meth:`orbex.models.Model.write` expects.

        :param model: :class:`orbex.models.Model` for the conversion base
        :param fromtype:
    ...
    def to_field(self, model, field, fromtype=str, *, savepoint):
        ...
        :type field: :class:`orbex.fields.Field`
