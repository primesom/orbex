...
from orbex.tests import JsonRpcException, patch

from orbex.addons.base.tests.common import HttpCaseWithUserDemo, Mock
...
class TestUnsplashHttp(HttpCaseWithUserDemo):
    ...
    def test_access(self):
        ...
        with patch.object(requests, 'get', self._mocked_save_unsplash_url):
            ...
            with self.assertLogs("orbex.http", level="WARNING") as log_catcher, \
                 self.assertRaisesRegex(JsonRpcException, "orbex.exceptions.AccessError"):
            ...
            self.assertEqual(
                ...
                "WARNING:orbex.http:Sorry, you are not allowed to access this document.",
            )
