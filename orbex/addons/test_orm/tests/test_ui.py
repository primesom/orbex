...
class TestUi(HttpCaseWithUserDemo):
    ...
    def test_01_admin_widget_x2many(self):
        ...
        self.start_tour("/orbex/action-test_orm.action_discussions",
            'widget_x2many', login="admin", timeout=120)


@orbex.tests.tagged('-at_install', 'post_install')
class TestUiTranslation(orbex.tests.HttpCase):

    @mute_logger('orbex.sql_db', 'orbex.http')
    def test_01_sql_constraints(self):
        ...
        self.start_tour("/orbex/action-test_orm.action_categories",
