...
from orbex import Command, fields, models
from orbex.exceptions import AccessError, MissingError, UserError, ValidationError
from orbex.fields import Domain
from orbex.tests import Form, TransactionCase, tagged, users
from orbex.tools import float_repr, mute_logger
from orbex.tools.image import image_data_uri

from orbex.addons.base.tests.common import TransactionCaseWithUserDemo
from orbex.addons.base.tests.test_expression import TransactionExpressionCase
...
%endif"""
    ...
    @mute_logger('orbex.addons.base.models.ir_model')
    ...
    def test_85_binary_guess_zip(self):
        from orbex.addons.base.tests.test_mimetypes import ZIP  # noqa: PLC0415
    ...
    def test_86_text_base64_guess_svg(self):
        from orbex.addons.base.tests.test_mimetypes import SVG  # noqa: PLC0415
...
%endif"""
    ...
    @patch('orbex.orm.fields_textual.html_sanitize', return_value='<p>comment</p>')
...
class TestSelectionOndeleteAdvanced(TransactionCase):
    ...
    def test_ondelete_unexisting_policy(self):
        from orbex.orm.model_classes import add_to_registry  # noqa: PLC0415
...
class TestFieldParametersValidation(TransactionCase):
    def test_invalid_parameter(self):
        ...
        with self.assertLogs('orbex.fields', level='WARNING') as cm:
            self.registry._setup_models__(self.env.cr, [])  # incremental setup

        self.assertTrue(cm.output[0].startswith(
            "WARNING:orbex.fields:Field test_orm.field_parameter_validation.name: "
...
class TestUnlinkConstraints(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        from orbex.addons.base.models.ir_model import (  # noqa: PLC0415
