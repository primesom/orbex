...
from orbex import _, api, Command, fields, models, modules, tools
from orbex.exceptions import UserError
from orbex.http import request
from orbex.tools import email_normalize, str2bool
...
class ResUsers(models.Model):
    ...
    notification_type = fields.Selection([
        ...
        help="Policy on how to handle Chatter notifications:\n"
             ...
             "- In Orbex: notifications appear in your Orbex Inbox")
    ...
    _notification_type = models.Constraint(
        ...
        'Only internal user can receive notifications in Orbex',
    )
