/** @orbex-module alias=@web/../tests/utils default=false */

import { __debug__, after, afterEach, expect, getFixture } from "@orbex/hoot";
import { queryAll, queryFirst } from "@orbex/hoot-dom";
 ...
 *
 * @param {import("@orbex/hoot-dom").Target} selector
 ...
 *  element.
 * @property {HTMLElement|OrbexEnv} [target=getFixture()]
...
class Contains {
    ...
    constructor(selector, options = {}) {
        ...
        if (this.options.target?.testEnv) {
            // when OrbexEnv, special key `target`. See @start
