...
import { manuallyDispatchProgrammaticEvent } from "@orbex/hoot-dom";
import { tick } from "@orbex/hoot-mock";
...
test("should show replace URL button if link is created by transformation", async () => {
    onRpc("/html_editor/link_preview_external", () => ({
        ...
        og_type: "website",
        og_site_name: "Orbex",
        source_url: "https://orbexsuite.com",
    }));
    const { editor } = await setupEditor(`<p>[]</p>`);
    await insertText(editor, "https://orbexsuite.com ");
