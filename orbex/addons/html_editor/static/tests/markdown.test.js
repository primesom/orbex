...
import { animationFrame, press } from "@orbex/hoot-dom";
...
describe("inline code", () => {
    ...
    test.tags("desktop");
    test("should not open the orbex global command bar when pressing ctrl+k inside a inline code element", async () => {
