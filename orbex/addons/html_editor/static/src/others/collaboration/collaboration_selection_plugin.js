...
export class CollaborationSelectionPlugin extends Plugin {
    ...
    static dependencies = ["history", "collaborationOrbex", "position", "localOverlay"];
    ...
    /**
     * @param {import("./collaboration_orbex_plugin").CollaborationSelection} selection
     */
    ...
    drawPeerSelection({ selection, peerId }) {
        const peerMetadata = this.dependencies.collaborationOrbex.getPeerMetadata(peerId);
        if (!peerMetadata) {
            return;
        }
