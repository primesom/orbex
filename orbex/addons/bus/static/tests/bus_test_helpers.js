import { after, expect, registerDebugInfo } from "@orbex/hoot";
import { Deferred } from "@orbex/hoot-mock";
import {
    MockServer,
    asyncStep,
    defineModels,
...
import { on, runAllTimers, waitUntil } from "@orbex/hoot-dom";
 ...
 *
 * @typedef {import("@web/env").OrbexEnv} OrbexEnv
...
/** @type {Record<string, (env: OrbexEnv, id: string, payload: any) => any>} */
const busMessageHandlers = {};
/** @type {Map<OrbexEnv, { id: number, type: string, payload: NotificationPayload }[]>} */
 ...
 *
 * @param {string} type
 * @param {(env: OrbexEnv, id: string, payload: any) => any} handler
 */
