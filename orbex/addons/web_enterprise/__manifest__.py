...
{
    'name': 'Orbex Web Enterprise Theme',
    'category': 'Hidden',
    'version': '1.0',
    'description': """
Orbex Web Enterprise Theme
==========================

This module modifies the web addon to provide an enterprise-style web client and responsive behavior.
    """,
    ...
    'assets': {
        ...
        'web.assets_backend': [
            'web_enterprise/static/src/scss/mobile_backend_fixes.scss',
