...
_BUBBLEUP_EXCEPTIONS = (
    orbex.exceptions.ConcurrencyError,  # let retrying handle this error
    orbex.exceptions.UserError,
    orbex.exceptions.RedirectWarning,
...
`orbex.tools.safe_eval.wrap_module` to generate a wrapper recursively
whitelisting allowed attributes.

Pre-wrapped modules are provided as attributes of `orbex.tools.safe_eval`.
""")
    return d
...
from orbex._monkeypatches.pytz import patch_module as patch_pytz  # noqa: E402, F401
patch_pytz()
