...
from orbex.exceptions import AccessError, MissingError, UserError
from orbex.tools import SQL, OrderedSet, Query, sql, unique
from orbex.tools.constants import PREFETCH_MAX
from orbex.tools.misc import SENTINEL, Sentinel, unquote
...
if typing.TYPE_CHECKING:
    ...
    from orbex.tools.misc import Collector
...
class Many2one(_Relational):
    ...
    :param bool check_company: Mark the field to be verified in
        :meth:`~orbex.models.Model._check_company`. Has a different behaviour
...
class Many2many(_RelationalMulti):
    ...
    :param bool check_company: Mark the field to be verified in
        :meth:`~orbex.models.Model._check_company`. Add a default company
