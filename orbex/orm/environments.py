...
"""The orbex API module defines orbex Environments.
"""
...
from orbex.exceptions import AccessError, UserError, CacheMiss
from orbex.sql_db import BaseCursor
from orbex.tools import clean_context, frozendict, reset_cached_properties, OrderedSet, Query, SQL
from orbex.tools.translate import get_translation, get_translated_module, LazyGettext
from orbex.tools.misc import StackMap, SENTINEL
...
_logger = logging.getLogger('orbex.api')
...
class Environment(Mapping[str, "BaseModel"]):
    ...
    def __call__(
        ...
        :type cursor: :class:`~orbex.sql_db.Cursor`
    ...
    def user(self) -> BaseModel:
        ...
        :rtype: :class:`res.users record<~orbex.addons.base.models.res_users.ResUsers>`"""
    ...
    def company(self) -> BaseModel:
        ...
        :rtype: :class:`res.company record<~orbex.addons.base.models.res_company.Company>`
    ...
    def companies(self) -> BaseModel:
        ...
        :rtype: :class:`res.company recordset<~orbex.addons.base.models.res_company.Company>`
...
class Transaction:
    ...
    def __init__(self, registry: Registry):
        ...
        # temporary directories (managed in orbex.tools.file_open_temporary_directory)
