...
from orbex.exceptions import AccessError, UserError, MissingError
from orbex.tools import SQL, OrderedSet, is_list_of, html_sanitize
from orbex.tools.misc import frozendict, has_list_types
...
class Properties(Field):
    ...
    like orbex fields but without being independently stored in database.
    ...
    current record. The container must have a :class:`~orbex.fields.PropertiesDefinition`
...
class PropertiesDefinition(Field):
    """ Field used to define the properties definition (see :class:`~orbex.fields.Properties`
