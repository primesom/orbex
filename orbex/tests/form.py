# -*- coding: utf-8 -*-
"""
The module :mod:`orbex.tests.form` provides an implementation of a client form
...
class Form:
    ...
    * properly handle defaults & onchanges around x2many fields.
    ...
    of :class:`~orbex.fields.Many2one` fields, one can assign a recordset::
    ...
    For :class:`~orbex.fields.Many2many` fields, the field itself is a
    :class:`~orbex.tests.common.M2MProxy` and can be altered by adding or
    removing records::
    ...
    Finally :class:`~orbex.fields.One2many` are reified as :class:`~O2MProxy`.

    Because the :class:`~orbex.fields.One2many` only exists through its parent,
...
class O2MProxy(X2MProxy):
    ...
    def new(self):
        ...
        :class:`~orbex.fields.One2many` record, properly initialised.
    ...
    def edit(self, index):
        ...
        :class:`~orbex.fields.One2many` record.
