...
orbex_TEST_MAX_FAILED_TESTS = max(1, int(os.environ.get('orbex_TEST_MAX_FAILED_TESTS', sys.maxsize)))

stats_logger = logging.getLogger('orbex.tests.stats')
...
class orbexTestResult(object):
    ...
    def _checkShouldStop(self):
        if self.total_errors_count() >= orbex_TEST_MAX_FAILED_TESTS:
            ...
            if not global_report.shouldStop:
                _logger.error(
                    ...
                    "Remaining tests will be skipped.", orbex_TEST_MAX_FAILED_TESTS)
