...
orbex will use the SQL function 'unaccent' when available for the
...
import orbex.orm.domains as orm_domains
...
def normalize_domain(domain):
    ...
    """
    warnings.warn("Since 19.0, use orbex.fields.Domain", DeprecationWarning)
...
def get_unaccent_wrapper(cr):
    ...
    return orbex.modules.registry.Registry(cr.dbname).unaccent
