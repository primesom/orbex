...
product_name = 'Orbex Suite'
description = 'Orbex Suite Server'
long_desc = '''Orbex Suite is a complete ERP and CRM. The main features are accounting (analytic
...
author = 'OpenERP S.A.'
author_email = 'info@orbexsuite.com'
license = 'LGPL-3'

nt_service_name = "orbex-server-" + series.replace('~','-')
