...
from orbex import api, http
from orbex.exceptions import (
    AccessDenied,
    AccessError,
    ConcurrencyError,
    UserError,
...
from orbex.tools.safe_eval import _UNSAFE_ATTRIBUTES
...
def retrying(func, env):
    ...
    :param orbex.api.Environment env: The environment where the registry
