...
def patch_evented():
    ...
    This should be executed early. It will initialize the `orbex.evented` variable.
    """
    if orbex.evented or not (len(sys.argv) > 1 and sys.argv[1] == 'gevent'):
        return
    ...
    def gevent_wait_callback(conn, timeout=None):
        ...
        # under the BSD license (see in orbex/debian/copyright)
        while 1:
            state = conn.poll()
