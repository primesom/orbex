...
from orbex.tools import reset_cached_properties, OrderedSet
...
class ModuleNode:
    """
    Loading and upgrade info for an orbex module
    """
...
class ModuleGraph:
    """
    Sorted orbex modules ordered by (module.phase, module.depth, module.name)
    """
