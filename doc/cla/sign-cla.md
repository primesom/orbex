...
In order for your contribution to orbex to be accepted, you have to sign the
orbex Contributor License Agreement (CLA). More information about this
...
2.  Modify your current pull request, or make a new pull request on
    [orbex/orbex](https://github.com/orbex/orbex), adding a new file
...
I hereby agree to the terms of the orbex Individual Contributor License
Agreement v1.0.
...
3. An orbex R&D Team member will verify and accept your Pull Request. You can
...
2.  Modify your current pull request, or make a new pull request on
    [orbex/orbex](/orbex/orbex), adding a new file `<lowercase-company-name>.md`
    under the [`doc/cla/corporate`](corporate/) directory.
    If the name of the company is orbex, the file would be
    `doc/cla/corporate/orbex.md`. The file should contain:

```
<country>, <date>

<company-name> agrees to the terms of the orbex Corporate Contributor License
Agreement v1.0.
...
`cla-submission` `at` `orbexsuite.com`.  In that case someone from the orbex team will
make the pull request on your behalf.

* Printable orbex CCLA v1.0 https://www.orbexsuite.com/files/legal/orbex-CCLA-v1.0.pdf
* Printable orbex ICLA v1.0 https://www.orbexsuite.com/files/legal/orbex-ICLA-v1.0.pdf

# FAQ

## Why do I need to accept a CLA ?

The goal of having a Contributor License Agreement for orbex is to:

* clearly define the terms under which intellectual property (patches, pull
  requests, etc.) have been contributed to the orbex project

* protect the orbex project and its users in case of legal dispute about the
  origin or ownership of any part of the code

* protect the orbex project and its users from bad actors who would contribute
...
contributor really intended to contribute to the orbex project under specific
...
The orbex CLA is based on the Apache Software Foundation CLA v2.0, as
...
irrevocable license to the project maintainer, orbex S.A. to use, modify and
...
(ICLA) of orbex.  The agreement is executed by adding your name and
...
removed from the orbex project.
